...
<body>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            // Play sound after a tiny delay
            setTimeout(() => {
                // playBabyTurtleSound(); // Muted for auto-start
            }, 300);

            // Hide splash after 2.5 seconds and AUTO-LOGIN AS SUPERVISOR
            setTimeout(() => {
                splash.style.opacity = '0';
                setTimeout(() => {
                    splash.style.display = 'none';

                    // FORCE SUPERVISOR LOGIN DIRECTLY (Bypassing User Selector)
                    console.log("🚀 Auto-starting as Supervisor...");
                    selectUserForLogin('supervisor', 999);
        ...
        <div class="modal" style="max-width: 450px;">
            ...
            <div class="form-group">
                ...
                <select id="eq-tipo" class="form-control">
                    <option value="equipo">Equipo (Maquinaria/Unidad)</option>
    ...
    <div id="modal-tecnico" class="modal-overlay">
        <div class="modal" style="max-width: 400px;">
            ...
            <div style="display: flex; gap: 8px; margin-top: 15px;">
                <button id="btn-delete-tecnico" class="btn" onclick="deleteTecnico()"
                    style="background: rgba(239, 68, 68, 0.1); color: var(--color-danger); border: 1px solid var(--color-danger); display: none;">
                    ELIMINAR
                </button>
        ...
        <div class="app-container" style="display: none;">
            <header>
                ...
                <div class="header-actions">
                    <div id="header-avatar-container" class="avatar-container" onclick="navigate('perfil')"
                        title="Mi Perfil"></div>
            ...
            <nav class="sidebar-nav">
                ...
                <button class="btn btn-sidebar" onclick="navigate('activos')" id="nav-activos">
                ...
                <button class="btn btn-sidebar" onclick="navigate('gantt')" id="nav-gantt">
                    <span class="material-symbols-rounded">calendar_view_day</span> Carta Gantt
                </button>
                <button class="btn btn-sidebar" onclick="navigate('calendario')" id="nav-calendario">
                    <span class="material-symbols-rounded">calendar_month</span> Calendario
                </button>
                <button class="btn btn-sidebar" onclick="navigate('habitaciones')" id="nav-habitaciones">
                    <span class="material-symbols-rounded">door_front</span> Registro Cuartos
                </button>
                <button class="btn btn-sidebar" onclick="navigate('bitacora')" id="nav-bitacora"
                    style="border-top: 1px solid rgba(255,255,255,0.05); margin-top: 10px; padding-top: 15px;">
                    <span class="material-symbols-rounded" style="color: #f59e0b;">book_2</span> Bitácora Pro
                </button>


                <!-- Version/Status -->
                <div style="margin-top: auto; padding: 1rem; text-align: center;">
                    <button onclick="exportPortableApp()" class="btn"
                        style="width: 100%; font-size: 0.7rem; background: rgba(16, 185, 129, 0.1); color: var(--color-success); border: 1px solid rgba(16, 185, 129, 0.3); padding: 8px;">
                        <span class="material-symbols-rounded"
                            style="font-size: 14px; vertical-align: middle;">save</span>
                        DESCARGAR APP
                    </button>
                    <div style="font-size: 0.65rem; color: var(--color-text-muted); margin-top: 5px; opacity: 0.7;">
                        ACTUALIZACIÓN
                    </div>
                </div>
            </nav>
            ...
            <nav class="mobile-nav">
                ...
                <div class="mobile-nav-item" onclick="navigate('habitaciones')" id="nav-habitaciones-mobile">
                    <span class="material-symbols-rounded">door_front</span>
                    <span>Cuartos</span>
                </div>
                <div class="mobile-nav-item" onclick="navigate('gantt')" id="nav-gantt-mobile">
                    <span class="material-symbols-rounded">calendar_view_day</span>
                    <span>Gantt</span>
                </div>
                <div class="mobile-nav-item" onclick="navigate('calendario')" id="nav-calendario-mobile">
    ...
    <script>
        ...
        const backupData = {
            "cmms_repuestos": [{ "id": 1, "nombre": "Compresor Scroll 5HP", "stock": 2, "stockMinimo": 1, "precio": 450000, "unidad": "UN", "critico": 1, "zona": "Motores", "pasillo": "A", "estante": "01", "nivel": "1", "tipo": "repuesto" }, { "id": 2, "nombre": "Filtro Aire G4", "stock": 24, "stockMinimo": 10, "precio": 12500, "unidad": "UN", "critico": 10, "zona": "Clima", "pasillo": "B", "estante": "03", "nivel": "2", "tipo": "repuesto" }, { "id": 3, "nombre": "Correa Transmisión A-42", "stock": 8, "stockMinimo": 4, "precio": 8500, "unidad": "UN", "critico": 4, "zona": "Motores", "pasillo": "A", "estante": "02", "nivel": "1", "tipo": "repuesto" }, { "id": 4, "nombre": "Capacitor 45uF", "stock": 15, "stockMinimo": 5, "precio": 6000, "unidad": "UN", "critico": 5, "zona": "Eléctrico", "pasillo": "C", "estante": "01", "nivel": "3", "tipo": "repuesto" }, { "id": 5, "nombre": "Gas R-410A (Balón 11kg)", "stock": 5, "stockMinimo": 2, "precio": 185000, "unidad": "UN", "critico": 2, "zona": "Químicos", "pasillo": "D", "estante": "01", "nivel": "1", "tipo": "repuesto" }, { "id": 201, "nombre": "Caja Herramientas Taller 01", "stock": 1, "stockMinimo": 1, "precio": 150000, "unidad": "UN", "critico": 1, "zona": "Taller", "pasillo": "T", "estante": "01", "nivel": "1", "tipo": "herramienta", "responsable": "" }, { "id": 202, "nombre": "Caja Herramientas Taller 02", "stock": 1, "stockMinimo": 1, "precio": 150000, "unidad": "UN", "critico": 1, "zona": "Taller", "pasillo": "T", "estante": "01", "nivel": "2", "tipo": "herramienta", "responsable": "" }, { "id": 203, "nombre": "Caja Herramientas Taller 03", "stock": 1, "stockMinimo": 1, "precio": 150000, "unidad": "UN", "critico": 1, "zona": "Taller", "pasillo": "T", "estante": "01", "nivel": "3", "tipo": "herramienta", "responsable": "" }, { "id": 204, "nombre": "Caja Herramientas Taller 04", "stock": 1, "stockMinimo": 1, "precio": 150000, "unidad": "UN", "critico": 1, "zona": "Taller", "pasillo": "T", "estante": "02", "nivel": "1", "tipo": "herramienta", "responsable": "" }, { "id": 205, "nombre": "Caja Herramientas Taller 05", "stock": 1, "stockMinimo": 1, "precio": 150000, "unidad": "UN", "critico": 1, "zona": "Taller", "pasillo": "T", "estante": "02", "nivel": "2", "tipo": "herramienta", "responsable": "" }],
            "cmms_tools": [],
            "cmms_tecnicos": [{ "id": 5, "nombre": "Marta Gómez", "userCode": "MG005", "password": "123", "especialidad": "General", "foto": "https://i.ibb.co/C8v8z8L/tech5.jpg", "salario": 750000, "costoHora": 4166, "isTitular": false, "origen": "planta", "empresa": "Hotel 5*", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 }, "pin": "1111" }, { "id": 6, "nombre": "Felipe Ruiz", "userCode": "FR006", "password": "123", "especialidad": "Electrónica", "foto": "https://i.ibb.co/9vL8z8L/tech6.jpg", "salario": 950000, "costoHora": 5277, "isTitular": false, "origen": "planta", "empresa": "Hotel 5*", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 }, "pin": "1111" }, { "id": 7, "nombre": "Diego Silva", "userCode": "DS007", "password": "123", "especialidad": "Infraestructura", "foto": "https://i.ibb.co/7vL8z8L/tech7.jpg", "salario": 750000, "costoHora": 4166, "isTitular": false, "origen": "planta", "empresa": "Hotel 5*", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 }, "pin": "1111" }, { "id": 8, "nombre": "2026", "userCode": "TEC008", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=2026&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 9, "nombre": "MANTENCION", "userCode": "TEC009", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=MANTENCION%20&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 10, "nombre": "NOMBRES", "userCode": "TEC010", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=NOMBRES&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 11, "nombre": "PABLO ORELLANA", "userCode": "TEC011", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=PABLO%20ORELLANA&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 12, "nombre": "miguel tapia", "userCode": "TEC012", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=miguel%20tapia&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 13, "nombre": "lizardo", "userCode": "TEC013", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=lizardo&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 14, "nombre": "JORGE CASTRO", "userCode": "TEC014", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=JORGE%20CASTRO&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 15, "nombre": "ALEJANDRO QUIROZ", "userCode": "TEC015", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=ALEJANDRO%20QUIROZ&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }, { "id": 16, "nombre": "JONATAN", "userCode": "TEC016", "password": "123", "pin": "1111", "especialidad": "Técnico (Excel)", "foto": "https://ui-avatars.com/api/?name=JONATAN%20&background=random&color=fff", "salario": 0, "costoHora": 0, "isTitular": false, "origen": "externo", "empresa": "Importado Excel", "eficacia": 100, "turno": { "inicio": "08:00", "fin": "18:00", "colacion": 60 } }],
            "cmms_ots": [{ "id": 101, "titulo": "Emergencia: Falla Chiller Rooftop", "asignadoId": null, "prioridad": "ALTA", "estado": "levantamiento", "descripcion": "Carga inicial.", "tipo": "no_programado", "asignadoNombre": null }, { "id": 102, "titulo": "Preventivo Mensual Compresor", "asignadoId": null, "prioridad": "MEDIA", "estado": "ejecucion", "descripcion": "Limpieza filtros.", "tipo": "programado", "asignadoNombre": null }, { "id": 103, "titulo": "Revisión Tablero Eléctrico", "asignadoId": null, "prioridad": "BAJA", "estado": "completada", "descripcion": "Todo ok.", "tipo": "programado", "comentario_tecnico": "Sin hallazgos.", "costo": 12000, "archivado": false, "asignadoNombre": null }],
            "cmms_equipos": [{ "id": 1, "nombre": "Compresor Sala Frío", "area": "Cocina", "estado": "activo", "dispo": 99, "marca": "Daikin", "modelo": "VRV IV", "horas": 1240, "freq": 250, "servicio": "planta", "criticidad": "AA", "x": 25, "y": 70, "notas": "Ubicado detrás de la cava de vinos.", "fechaInicio": "2026-01-01", "capacidad": "48,000 BTU", "refrigerante": "R-410A", "tension": "Trifásica 380V", "compresor": "Scroll Inv.", "valorMercado": 8500000, "valorAdquisicion": 12000000, "costoMantAcumulado": 450000, "especialidad": "Clima", "kitRepuestos": [{ "nombre": "Filtro G4", "precio": 15000 }, { "nombre": "Gas R-410A (kg)", "precio": 45000 }], "historial": [{ "fecha": "2025-12-12", "tarea": "Mant. Preventivo", "tecnico": "Juan Pérez", "especialidad": "Clima", "efectividad": 98, "origen": "planta", "desc": "Ajuste de correas y lubricación.", "costo": 25000, "tipo": "programado" }] }, { "id": 2, "nombre": "Chiller Central", "area": "Azotea", "estado": "alerta", "dispo": 62, "marca": "York", "modelo": "YK-Series", "horas": 5600, "freq": 500, "servicio": "externo", "criticidad": "AAA", "x": 50, "y": 15, "notas": "Requiere revisión de presión de refrigerante.", "fechaInicio": "2026-01-01", "capacidad": "250 TR", "refrigerante": "R-134a", "tension": "Trifásica 380V", "compresor": "Tornillo", "valorMercado": 45000000, "valorAdquisicion": 65000000, "costoMantAcumulado": 12500000, "especialidad": "Clima", "kitRepuestos": [{ "nombre": "Válvula Expansión", "precio": 850000 }, { "nombre": "Aceite Sintético", "precio": 120000 }], "historial": [{ "fecha": "2025-11-20", "tarea": "Reparación Fuga", "tecnico": "ClimaCorp S.A.", "especialidad": "Clima", "efectividad": 85, "origen": "externo", "desc": "Cambio de válvula de expansión.", "costo": 950000, "tipo": "no_programado" }] }, { "id": 3, "nombre": "Generador Diesel", "area": "Subterráneo", "estado": "activo", "dispo": 100, "marca": "Caterpillar", "modelo": "C15", "horas": 45, "freq": 100, "servicio": "planta", "criticidad": "AAA", "x": 75, "y": 85, "notas": "Prueba semanal los lunes 09:00 AM.", "fechaInicio": "2026-01-01", "capacidad": "500 kVA", "refrigerante": "Diesel / Glicol", "tension": "Trifásica 380V", "compresor": "Combustión", "valorMercado": 120000000, "valorAdquisicion": 150000000, "costoMantAcumulado": 2100000, "especialidad": "Mecánica", "kitRepuestos": [{ "nombre": "Filtro Petróleo", "precio": 85000 }, { "nombre": "Aceite 15W40", "precio": 140000 }], "historial": [{ "fecha": "2025-12-01", "tarea": "Cambio Aceite", "tecnico": "Carlos Ruiz", "especialidad": "Mecánica", "efectividad": 100, "origen": "planta", "desc": "Filtros y aceite nuevos.", "costo": 225000, "tipo": "programado" }] }, { "id": 4, "nombre": "Caldera de Vapor", "area": "Sala Térmica", "estado": "activo", "dispo": 98, "marca": "Bosch", "modelo": "Universal", "horas": 4100, "freq": 4000, "servicio": "externo", "criticidad": "AAA", "x": 80, "y": 20, "notas": "Crítica para agua caliente sanitaria.", "fechaInicio": "2026-01-01", "capacidad": "2000 kg/h", "refrigerante": "Gas Natural", "tension": "380V", "compresor": "Quemador", "valorMercado": 35000000, "valorAdquisicion": 40000000, "costoMantAcumulado": 800000, "especialidad": "Termodinámica", "kitRepuestos": [{ "nombre": "Juntas de Quemador", "precio": 45000 }, { "nombre": "Electrodo", "precio": 25000 }], "historial": [] }, { "id": 5, "nombre": "Ascensor de Servicio", "area": "Lobby", "estado": "activo", "dispo": 95, "marca": "Schindler", "modelo": "3300", "horas": 1200, "freq": 3000, "servicio": "externo", "criticidad": "AAA", "x": 40, "y": 40, "notas": "Uso intensivo carga/descarga.", "fechaInicio": "2026-01-01", "capacidad": "1000 kg", "refrigerante": "N/A", "tension": "380V", "compresor": "Motor Tracción", "valorMercado": 60000000, "valorAdquisicion": 75000000, "costoMantAcumulado": 1500000, "especialidad": "Mecánica", "kitRepuestos": [], "historial": [] }, { "id": 6, "nombre": "Bomba Hidroneumática", "area": "Sala Bombas", "estado": "activo", "dispo": 100, "marca": "Pedrollo", "modelo": "F", "horas": 500, "freq": 1000, "servicio": "planta", "criticidad": "AA", "x": 60, "y": 70, "notas": "Presión constante agua potable.", "fechaInicio": "2026-01-01", "capacidad": "500 L/min", "refrigerante": "N/A", "tension": "380V", "compresor": "Centrífuga", "valorMercado": 1200000, "valorAdquisicion": 1500000, "costoMantAcumulado": 50000, "especialidad": "Hidráulica", "kitRepuestos": [{ "nombre": "Sello Mecánico", "precio": 35000 }], "historial": [] }],
            "cmms_management": [],
            "cmms_labor": [],
            "cmms_tool_suggestions": [],
            "cmms_ordenes_compra": [],
            "cmms_biblioteca": [
        ...
        const defaultEquipos = backupData.cmms_equipos;
        const defaultTecnicos = backupData.cmms_tecnicos;
        ...
        let laborLogs = JSON.parse(localStorage.getItem('cmms_labor')) || backupData.cmms_labor; // [{idOT, idTec, action, timestamp, comment}]
        let managementLogs = JSON.parse(localStorage.getItem('cmms_management')) || backupData.cmms_management; // [{id, action, detail, icon, timestamp}]
        let toolLogs = JSON.parse(localStorage.getItem('cmms_tools')) || backupData.cmms_tools; // [{tecnico, herramienta, estado, fecha}]
        let ots = JSON.parse(localStorage.getItem('cmms_ots')) || backupData.cmms_ots;

        // --- HYDRATION ENGINE v4.0 ---
        // Restore images that were stripped from LocalStorage to save space
        function hydrateImages(targetArray, sourceArray) {
            if (!targetArray || !sourceArray) return;
            targetArray.forEach(item => {
                if (item.foto === '[IMAGE_ARCHIVED]') {
                    const original = sourceArray.find(src => src.id === item.id);
                    if (original) item.foto = original.foto;
                }
            });
        }

        hydrateImages(equipos, backupData.cmms_equipos);
        hydrateImages(tecnicos, backupData.cmms_tecnicos);
        hydrateImages(ots, backupData.cmms_ots);

        const defaultRepuestos = backupData.cmms_repuestos;
        ...
        let registroHabitaciones = JSON.parse(localStorage.getItem('cmms_habitaciones')) || [];


        let toolSuggestions = JSON.parse(localStorage.getItem('cmms_tool_suggestions')) || backupData.cmms_tool_suggestions;
        let ordenesCompra = JSON.parse(localStorage.getItem('cmms_ordenes_compra')) || backupData.cmms_ordenes_compra;
        let biblioteca = JSON.parse(localStorage.getItem('cmms_biblioteca')) || backupData.cmms_biblioteca;
        let proveedores = JSON.parse(localStorage.getItem('cmms_proveedores')) || [
        ...
        let customAreas = JSON.parse(localStorage.getItem('cmms_custom_areas')) || [];

        // --- MIGRACIÓN Y POBLADO DE DATOS (v4.0 Managerial) ---
        const V4_DATA_KEY = 'cmms_v4_managerial_v1';
        if (!localStorage.getItem(V4_DATA_KEY)) {
            // Only set flag, DO NOT save massive data immediately
            localStorage.setItem(V4_DATA_KEY, 'true');
        }

        // Helper to strip large images ONLY if they match backup (Safe Archiving)
        function createReplacer(backupArray) {
            return function (key, value) {
                // 'this' is the object being processed (e.g., the OT object)
                if ((key === 'foto' || key === 'imagen' || key === 'img' || key === 'firma') &&
                    typeof value === 'string' && value.length > 500 && value.startsWith('data:image')) {

                    // If we have a backup source, check if this image is original
                    if (backupArray) {
                        const original = backupArray.find(i => i.id === this.id);
        ...
        function persist() {
            try {
                // Save using smart replacers for heavy collections
                localStorage.setItem('cmms_equipos', JSON.stringify(equipos, createReplacer(backupData.cmms_equipos)));
                localStorage.setItem('cmms_tecnicos', JSON.stringify(tecnicos, createReplacer(backupData.cmms_tecnicos)));
                localStorage.setItem('cmms_ots', JSON.stringify(ots, createReplacer(backupData.cmms_ots)));

                // Standard saves for lighter/new collections
                ...
                localStorage.setItem('cmms_biblioteca', JSON.stringify(biblioteca));
                localStorage.setItem('cmms_proveedores', JSON.stringify(proveedores));
                localStorage.setItem('cmms_custom_areas', JSON.stringify(customAreas));
                ...
                // --- DIRECT CLOUD SYNC CALL ---
                if (window.syncToCloud) {
                    window.syncToCloud().catch(err => console.error("Cloud Sync Failed:", err));
                } else {
                    console.warn("⚠️ syncToCloud function not found - running offline mode");
                }

            } catch (e) {
                console.error("Storage Error:", e);
                // Suppressed alert to avoid blocking workflow
            }
        }

        // --- FUNCIONES FALTANTES: SAVE EQUIPO & CLOSE MODAL ---
        function saveEquipo() {
            ...
            const valorMercado = document.getElementById('eq-valor-mercado').value;
            const valorAdq = document.getElementById('eq-valor-adq').value;
            ...
            const diagnostico = document.getElementById('eq-diagnostico').value;
            const notas = document.getElementById('eq-notas').value;
            const fotoInput = document.getElementById('eq-foto');

            if (!nombre || !area) {
                alert("⚠️ Por favor completa el Nombre y Área del equipo.");
                return;
            }

            // Find existing to preserve history if editing
            let existing = null;
            if (id) {
                existing = equipments.find(e => e.id == id) || equipos.find(e => e.id == id);
            }
            ...
            const equipo = {
                ...
                tipo: tipo,
                area: area,
                valorMercado: parseInt(valorMercado) || 0,
                valorAdquisicion: parseInt(valorAdq) || 0,
                horas: parseInt(horas) || 0,
                freq: parseInt(freq) || 250,
                criticidad: isCritico ? 'AA' : 'A',
                especialidad: especialidad,
                estado: estado,
                diagnostico: diagnostico,
                notas: notas,
                fechaInicio: existing ? existing.fechaInicio : new Date().toISOString().split('T')[0],
                // Default props to ensure compatibility
                dispo: 100,
                servicio: 'planta',
                historial: existing ? existing.historial : [],
                kitRepuestos: existing ? existing.kitRepuestos : []
            };

            // Helper to finish save
            const finalize = (eq) => {
                const index = equipos.findIndex(e => e.id === eq.id);
                if (index !== -1) {
                    equipos[index] = eq;
                } else {
                    equipos.push(eq);
                }
                persist(); // Triggers sync
                closeModal();
            ...
            if (fotoInput.files && fotoInput.files[0]) {
                ...
                reader.onload = function (e) {
                    equipo.foto = e.target.result;
                    finalize(equipo);
                };
                reader.readAsDataURL(fotoInput.files[0]);
            } else {
                // Preserve existing photo if editing
                if (existing && existing.foto) equipo.foto = existing.foto;
                finalize(equipo);
            }
        }
        ...
        function openModal() {
            ...
            document.getElementById('eq-horas').value = '';
        ...
        // --- JSON BACKUP ENGINE v3.5.2 ---
        function exportToJSON() {
            const backup = {
                timestamp: new Date().toISOString(),
                date: new Date().toLocaleString(),
                version: localStorage.getItem('app_version') || 'v3.5.2',
                data: {}
            };

            // Recolectar todas las claves cmms_
            for (let i = 0; i < localStorage.length; i++) {
                const key = localStorage.key(i);
                if (key.startsWith('cmms_') || key === 'app_version') {
            ...
            a.href = url;
            a.download = `XELONIA_BACKUP_${dateStr}.json`;
        ...
        function importFromJSON(event) {
            ...
            reader.onload = function (e) {
                try {
                    ...
                    if (!backup.data) throw new Error("Formato de backup no válido");

                    if (confirm("⚠️ ¿RESTAURAR COPIA DE SEGURIDAD?\n\nEsto reemplazará todos tus datos actuales por los del archivo (" + (backup.date || 'Desconocido') + ").\n\n¿Estás seguro?")) {
                        // Inyectar datos
                    ...
                    alert("❌ Error al importar: El archivo no es un backup válido de XELONIA.");
                }
                // Limpiar input
                event.target.value = '';
            };
        ...
        async function factoryReset() {
            if (confirm("⚠️ ¿RESETEO DE MANTENIMIENTO?\n\nEsta acción:\n1. Borrará los datos locales (caché).\n2. Forzará una recarga desde la nube.\n3. Solucionará problemas de versiones antiguas.\n\n¿Continuar?")) {
                ...
                // 2. Eliminar Service Workers (Cache PWA)
                if ('serviceWorker' in navigator) {
                    try {
                        ...
                        console.error("Error limpiando SW:", e);
                    }
                }

                // 3. Recargar forzando el servidor
                alert("✅ Sistema limpio. La aplicación se reiniciará para sincronizar.");
                window.location.reload(true);
            }
        }

        // --- PORTABLE APP EXPORTER (HTML + DATA) ---
        function exportPortableApp() {
            if (!confirm("💾 ¿DESCARGAR APP PORTÁTIL?\n\nSe generará un archivo .html único que contiene:\n1. Toda la aplicación (Código y Diseño).\n2. TODOS tus datos actuales (Equipos, Bitácora, OT, etc.).\n\nPodrás abrir este archivo en cualquier PC y tendrás tu sistema listo.")) return;

            // 1. Get current HTML
            let htmlContent = document.documentElement.outerHTML;

            // 2. Prepare Data Injection Script
            // This script will run immediately when the downloaded file opens, restoring data to localStorage
            let dataScript = "<script>";
            dataScript += "try {";
            dataScript += "  if(!localStorage.getItem('cmms_restored_v1')) {"; // Only restore once to avoid overwriting future changes in that file
            dataScript += "    console.log('📦 Restoring Embedded Data...');";

            // Iterate all localStorage items
            for (let i = 0; i < localStorage.length; i++) {
                const key = localStorage.key(i);
                const value = localStorage.getItem(key);
                // Escape single quotes and newlines to prevent syntax errors in the injected JS string
                const safeValue = value.replace(/\\/g, '\\\\').replace(/'/g, "\\'").replace(/\\n/g, "\\\\n").replace(/\\r/g, "");
                dataScript += `    localStorage.setItem('${key}', '${safeValue}');\n`;
            }

            dataScript += "    localStorage.setItem('cmms_restored_v1', 'true');"; // Mark as restored
            dataScript += "    alert('✅ DATOS RESTAURADOS CON ÉXITO\\n\\nBienvenido a tu App Portátil de XELONIA.\\nTus datos han sido cargados correctamente.');";
            dataScript += "  }";
            dataScript += "} catch(e) { console.error('Data Restore Error:', e); }";
            dataScript += "<\/script>"; // Escape closing script tag

            // 3. Inject Data Script before the closing </body> tag
            // We verify if </body> exists, if not we append it
            if (htmlContent.includes("</body>")) {
                htmlContent = htmlContent.replace("</body>", dataScript + "</body>");
            } else {
                htmlContent += dataScript; // Fallback
            }
            ...
            const dateStr = new Date().toISOString().split('T')[0];
            a.href = url;
            a.download = `XELONIA_APP_PORTATIL_${dateStr}.html`;
            document.body.appendChild(a);
            a.click();
            document.body.removeChild(a);
            URL.revokeObjectURL(url);
        ...
        function renderPerfil() {
            // FALLBACK FOR NULL USER (Emergency Mode)
            const safeUser = currentUser || { nombre: 'Usuario Desconocido', role: 'admin', foto: null, especialidad: 'Modo Recuperación' };
            const isAdmin = safeUser.role === 'admin' || emulatingSupervisor || !currentUser; // Force admin tools if no user

            const userName = safeUser.nombre;
            const userPhoto = safeUser.foto || 'https://via.placeholder.com/150';
            const userRole = isAdmin ? 'Supervisor (Recuperación)' : 'Técnico';
            const userSpecialty = safeUser.especialidad || (safeUser.especialidades ? safeUser.especialidades.join(', ') : 'N/A');
            ...
            return `
                <div class="view-content" style="max-width: 500px; margin: 0 auto;">
                    ...
                    ${!currentUser ? `
                        <div class="card" style="background: rgba(239, 68, 68, 0.1); border: 1px solid var(--color-danger); color: white; margin-bottom: 20px;">
                            <strong>⚠️ MODO RECUPERACIÓN</strong><br>
                            No se detecta sesión activa. Usa los botones abajo para restaurar tu copia de seguridad.
                        </div>
                    ` : ''}
                    ...
                    <div style="margin-top: 2rem; display: flex; flex-direction: column; gap: 12px;">
                        ...
                        <!-- JSON BACKUP TOOLS (ALWAYS VISIBLE IN RECOVERY) -->
                        <div style="background: rgba(59, 130, 246, 0.1); padding: 15px; border-radius: 12px; border: 1px solid rgba(59, 130, 246, 0.3); margin-bottom: 20px;">
                            <div style="font-size:0.8rem; color:var(--color-primary); margin-bottom:10px; text-align:center; font-weight:800; letter-spacing:1px;">DIAGNÓSTICO DE NUBE (v3.5.3-FIX)</div>
                            
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 10px;">
                                <button onclick="handleManualPull()" class="btn" style="padding: 0.8rem; background: var(--color-surface); border: 1px solid var(--color-accent); color: var(--color-accent); font-size: 0.75rem; display: flex; flex-direction:column; align-items: center; justify-content: center; gap: 5px;">
                                    <span class="material-symbols-rounded" style="font-size: 20px;">cloud_download</span>
                                    <span>DESCARGAR</span>
                                    <span style="font-size: 9px; opacity: 0.7;">(Nube ➔ Tablet)</span>
                                </button>
                                <button onclick="handleManualPush()" class="btn" style="padding: 0.8rem; background: var(--color-surface); border: 1px solid var(--color-success); color: var(--color-success); font-size: 0.75rem; display: flex; flex-direction:column; align-items: center; justify-content: center; gap: 5px;">
                                    <span class="material-symbols-rounded" style="font-size: 20px;">cloud_upload</span>
                                    <span>SUBIR</span>
                                    <span style="font-size: 9px; opacity: 0.7;">(PC ➔ Nube)</span>
                                </button>
                            </div>
                            <div id="sync-status-log" style="font-size: 0.7rem; color: var(--color-text-muted); text-align: center; min-height: 1.5em;">Esperando acción...</div>
                        </div>

                        <div style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.1);">
                            <div style="font-size:0.8rem; color:var(--color-text-muted); margin-bottom:10px; text-align:center;">HERRAMIENTAS DE RESPALDO LOCAL</div>
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                <button onclick="exportToJSON()" class="btn" style="padding: 0.8rem; background: rgba(16, 185, 129, 0.1); color: #10b981; border: 1px solid #10b981; font-size: 0.8rem; display: flex; align-items: center; justify-content: center; gap: 5px;">
                                    <span class="material-symbols-rounded" style="font-size: 18px;">download</span>
                                    Exportar JSON
                                </button>
                                <button onclick="document.getElementById('json-import-input').click()" class="btn" style="padding: 0.8rem; background: rgba(245, 158, 11, 0.1); color: #f59e0b; border: 1px solid #f59e0b; font-size: 0.8rem; display: flex; align-items: center; justify-content: center; gap: 5px;">
                                    <span class="material-symbols-rounded" style="font-size: 18px;">upload</span>
                                    Importar JSON
                                </button>
                            </div>
                            <input type="file" id="json-import-input" style="display: none;" accept=".json" onchange="importFromJSON(event)">
                        </div>
                    ...
                    <div style="margin-top: 2rem; padding: 1rem; background: rgba(255,255,255,0.02); border-radius: 8px; text-align: center; font-size: 0.75rem; color: var(--color-text-muted);">
                        <div style="margin-bottom: 8px;">
                            <strong>XELONIA uptime</strong> v3.5.2 (Rescue Mode)
                        </div>
                        <div>
        ...
        function selectUserForLogin(role, userId) {
            console.log("Direct Login Attempt:", role, userId);

            // SECURITY BYPASS v3.5.3 - Direct Access Logic
            if (role === 'supervisor' || role === 'admin') {
                currentUser = { id: 999, nombre: 'Administrator', role: 'admin' };
                currentRole = 'admin';
            } else {
                const tech = tecnicos.find(t => t.id === userId);
                if (tech) {
                    currentUser = tech;
                    currentRole = 'tecnico';
                }
            ...
            if (currentUser) {
                ...
                // 2. Ocultar selector y splash (si siguiera ahí)
                document.getElementById('user-selector-screen').style.display = 'none';
                const splash = document.getElementById('splash-screen');
                if (splash) splash.style.display = 'none';

                // 3. Mostrar app wrapper y container
                document.getElementById('app').style.display = 'block';
                const appContainer = document.querySelector('.app-container');
                if (appContainer) appContainer.style.display = 'grid';

                // 4. Aplicar UI según rol
                if (typeof toggleRoleUI === 'function') {
                    toggleRoleUI();
                } else {
                    // Fallback directo si toggleRoleUI no existe en esta versión
                ...
                console.log("✅ Access Granted: Welcome " + currentUser.nombre);
            }
        }
        ...
        async function handleManualPull() {
            ...
            if (log) log.innerText = "⏳ Descargando datos...";

            if (window.loadFromCloud) {
                const success = await window.loadFromCloud();
                if (success) {
                    const stats = `Equipos: ${equipos.length}, OTs: ${ots.length}`;
                    if (log) {
                        log.innerText = `✅ Descarga OK (${stats})`;
                    ...
                    if (log) {
                        log.innerText = "❌ Nube vacía o error.";
                        log.style.color = "var(--color-danger)";
                    }
                    alert("⚠️ No se encontraron datos en la nube. Sube datos desde el PC primero.");
                }
            } else {
                alert("❌ Error Crítico: Módulo de nube no cargado.");
            }
        }

        async function handleManualPush() {
            const log = document.getElementById('sync-status-log');
            if (log) log.innerText = "⏳ Subiendo datos...";
            ...
            if (window.syncToCloud) {
                try {
                    ...
                    if (log) {
                        const stats = `Equipos: ${equipos.length}, OTs: ${ots.length}`;
                        log.innerText = `✅ Subida OK (${stats})`;
                        log.style.color = "var(--color-success)";
                    }
                    alert(`✅ Respaldo en Nube EXITOSO.\nSe subieron ${equipos.length} equipos y ${ots.length} OTs.`);
                } catch (e) {
                    if (log) {
                        log.innerText = "❌ Error al subir.";
                        log.style.color = "var(--color-danger)";
                    }
        ...
        function renderDashboard() {
            ...
            // RENDER FINAL
            return headerHtml +
                renderBitacoraWidgets() + // Bitácora Radar
        ...
        function renderBitacora() {
            // Recargar datos por si hubo cambios externos
            loadBitacora();

            // Tabs internos
            const tabs = `
                <div style="display: flex; gap: 10px; margin-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px;">
                    <button onclick="bitacoraFiltro='todas'; bitacoraFiltroTemporal=null; renderCurrentView()" class="btn" style="background: ${!bitacoraFiltroTemporal ? 'rgba(59, 130, 246, 0.2)' : 'transparent'}; color: ${!bitacoraFiltroTemporal ? '#3b82f6' : 'var(--color-text-muted)'}">
                        📝 Nueva / Lista
                    </button>
                    <button onclick="bitacoraFiltroTemporal='reportes'; renderCurrentView()" class="btn" style="background: ${bitacoraFiltroTemporal === 'reportes' ? 'rgba(59, 130, 246, 0.2)' : 'transparent'}; color: ${bitacoraFiltroTemporal === 'reportes' ? '#3b82f6' : 'var(--color-text-muted)'}">
                        📊 Reportes PDF
                    </button>
                </div>
            `;
            ...
            // VISTA: REPORTES
            if (bitacoraFiltroTemporal === 'reportes') {
                return `
                    <div class="view-content">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                            <h3>Bitácora: Centro de Reportes</h3>
                            <div style="font-size: 0.8rem; color: var(--color-text-muted);">Generación de informes ejecutivos</div>
                        </div>
                        ${tabs}
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                            <div class="card">
                                ...
                                <p style="font-size: 0.8rem; color: var(--color-text-muted); margin-bottom: 15px;">Resumen de todas las entradas de HOY.</p>
                                <button class="btn btn-primary" onclick="bitacoraPDF('diario')" style="width: 100%;">Descargar PDF</button>
                            </div>
                            <div class="card">
                                <h4>📄 Informe Semanal</h4>
                                <p style="font-size: 0.8rem; color: var(--color-text-muted); margin-bottom: 15px;">Actividad de los últimos 7 días.</p>
                                <button class="btn btn-primary" onclick="bitacoraPDF('semanal')" style="width: 100%;">Descargar PDF</button>
                            </div>
                            <div class="card">
                                <h4>📄 Informe Mensual</h4>
                                <p style="font-size: 0.8rem; color: var(--color-text-muted); margin-bottom: 15px;">Resumen completo del mes actual.</p>
                                <button class="btn btn-primary" onclick="bitacoraPDF('mensual')" style="width: 100%;">Descargar PDF</button>
                            </div>
                            <div class="card" style="border-left: 4px solid #f59e0b;">
                                <h4>📋 Resumen Lunes (Ejecutivo)</h4>
                                <p style="font-size: 0.8rem; color: var(--color-text-muted); margin-bottom: 15px;">Solo entradas IMPORTANTES de la semana anterior (Lun-Vie).</p>
                                <button class="btn" onclick="bitacoraPDF('lunes')" style="width: 100%; background: rgba(245, 158, 11, 0.2); color: #f59e0b; border: 1px solid #f59e0b;">Descargar Resumen</button>
                            </div>
                        </div>

                        <div class="card" style="margin-top: 20px;">
                            <h4>⚙️ Configuración de Firma</h4>
                            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px; margin-top: 10px;">
                                <div>
                                    <label style="font-size: 0.7rem;">Nombre</label>
                                    <input type="text" id="cfg-bit-nombre" class="form-control" value="${bitacoraConfig.nombre}" onchange="updateBitacoraConfig()">
                                </div>
                                <div>
                                    <label style="font-size: 0.7rem;">Cargo</label>
                                    <input type="text" id="cfg-bit-cargo" class="form-control" value="${bitacoraConfig.cargo}" onchange="updateBitacoraConfig()">
                                </div>
                                <div>
                                    <label style="font-size: 0.7rem;">Empresa</label>
                                    <input type="text" id="cfg-bit-empresa" class="form-control" value="${bitacoraConfig.empresa}" onchange="updateBitacoraConfig()">
                                </div>
                            </div>
                        </div>

                        <div class="card" style="margin-top: 20px; border-left: 4px solid #10b981;">
                            <h4>💾 Gestión de Datos (Backup)</h4>
                            <p style="font-size: 0.8rem; color: var(--color-text-muted); margin-bottom: 10px;">Respaldar o restaurar exclusivamente los datos de la Bitácora.</p>
                            <div style="display: flex; gap: 10px;">
                                <button class="btn" onclick="downloadBitacoraJSON()" style="background: rgba(16, 185, 129, 0.2); color: #10b981; border: 1px solid #10b981;">
                                    ⬇️ Descargar JSON
                                </button>
                                <button class="btn" onclick="document.getElementById('file-upload-bitacora').click()" style="background: rgba(59, 130, 246, 0.2); color: #3b82f6; border: 1px solid #3b82f6;">
                                    ⬆️ Cargar JSON
                                </button>
                                <input type="file" id="file-upload-bitacora" accept=".json" style="display: none;" onchange="uploadBitacoraJSON(this)">
                            </div>
                        </div>
                    </div>
                `;
            ...
            // VISTA: LISTA Y NUEVA ENTRADA
            // Lógica de filtrado
            let entradasFiltradas = bitacoraDatos;
            const hoy = new Date().toISOString().split('T')[0];

            if (bitacoraFiltro === 'importantes') {
                entradasFiltradas = entradasFiltradas.filter(e => e.importante);
            } else if (bitacoraFiltro !== 'todas') {
                entradasFiltradas = entradasFiltradas.filter(e => e.categoria === bitacoraFiltro);
            }

            const listaHtml = entradasFiltradas.length === 0 ?
                '<div style="text-align: center; color: var(--color-text-muted); padding: 2rem;">No hay entradas registradas.</div>' :
                entradasFiltradas.slice(0, 50).map(e => {
                    // Logic to display linked asset name
                    let linkedInfo = '';
                    if (e.assetId) {
                        const asset = equipos.find(eq => eq.id === e.assetId);
                        const assetName = asset ? asset.nombre : 'Equipo desconocido';
                        linkedInfo = `<span style="font-size: 0.6rem; padding: 2px 6px; border-radius: 4px; background: rgba(59, 130, 246, 0.15); color: #60a5fa; border: 1px solid rgba(59, 130, 246, 0.3);">🔧 ${assetName}</span>`;
                    } else if (e.roomId) {
                        linkedInfo = `<span style="font-size: 0.6rem; padding: 2px 6px; border-radius: 4px; background: rgba(16, 185, 129, 0.15); color: #34d399; border: 1px solid rgba(16, 185, 129, 0.3);">🏨 ${e.roomId}</span>`;
                    }

                    return `
                    <div style="background: rgba(255,255,255,0.02); padding: 15px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); margin-bottom: 10px; position: relative;">
                         <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <div style="display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
                                <span style="font-size: 0.65rem; padding: 2px 6px; border-radius: 4px; background: rgba(255,255,255,0.1); text-transform: uppercase;">
                                    ${e.categoria}
                                </span>
                                ${e.importante ? '<span style="font-size: 0.65rem; color: #ef4444; font-weight: 800;">★ IMPORTANTE</span>' : ''}
                                ${linkedInfo}
                                ${e.esRecordatorio ? `<span style="font-size: 0.65rem; color: #f59e0b; font-weight: 800;">📅 ${e.fechaRecordatorio} ${e.completado ? '(OK)' : ''}</span>` : ''}
                            </div>
                            <div style="font-size: 0.7rem; color: var(--color-text-muted);">${e.fecha} ${e.hora || ''}</div>
                         </div>
                         <div style="font-size: 0.9rem; line-height: 1.5; white-space: pre-wrap;">${e.contenido}</div>
                         <button onclick="openEditBitacora(${e.id})" style="position: absolute; top: 10px; right: 10px; padding: 4px; border: none; background: transparent; color: var(--color-primary); cursor: pointer;" title="Editar">
            ...
            return `
                <div class="view-content">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        <h3>Bitácora Profesional</h3>
                        <div style="font-size: 0.8rem; color: var(--color-text-muted);">Registro de actividades e incidentes</div>
                    </div>
                    ${tabs}

                    <!-- BOTÓN NUEVA ENTRADA (MODAL) -->
                    <button onclick="openEditBitacora(null)" class="btn btn-primary" style="width: 100%; margin-bottom: 15px; padding: 12px; display: flex; align-items: center; justify-content: center; gap: 8px; font-weight: 700;">
                        <span class="material-symbols-rounded">add_circle</span>
                        NUEVA ENTRADA
                    </button>

                    <div style="display: flex; gap: 10px; margin-bottom: 15px; overflow-x: auto; padding-bottom: 5px;">
                        <button onclick="bitacoraFiltro='todas'; renderCurrentView()" class="btn" style="background: ${bitacoraFiltro === 'todas' ? 'rgba(255,255,255,0.1)' : 'transparent'}">Todas</button>
                        <button onclick="bitacoraFiltro='importantes'; renderCurrentView()" class="btn" style="background: ${bitacoraFiltro === 'importantes' ? 'rgba(255,255,255,0.1)' : 'transparent'}">★ Importantes</button>
                        <button onclick="bitacoraFiltro='mantenimiento'; renderCurrentView()" class="btn" style="background: ${bitacoraFiltro === 'mantenimiento' ? 'rgba(255,255,255,0.1)' : 'transparent'}">Mantenimiento</button>
                        <button onclick="bitacoraFiltro='incidente'; renderCurrentView()" class="btn" style="background: ${bitacoraFiltro === 'incidente' ? 'rgba(255,255,255,0.1)' : 'transparent'}">Incidentes</button>
                         <button onclick="bitacoraFiltro='reunion'; renderCurrentView()" class="btn" style="background: ${bitacoraFiltro === 'reunion' ? 'rgba(255,255,255,0.1)' : 'transparent'}">Reuniones</button>
                    </div>

                    <div id="bitacora-lista">
                        ${listaHtml}
                    </div>
                </div>
            `;
        ...
        // FUNCIONES DE LÓGICA DE BITÁCORA
        // FUNCIONES DE LÓGICA DE BITÁCORA (NUEVA)
        function openEditBitacora(id) {
            const modal = document.getElementById('modal-bitacora');
            const title = document.getElementById('bit-modal-title');
            const editId = document.getElementById('bit-edit-id');
            const contenido = document.getElementById('bit-contenido-modal');
            const categoria = document.getElementById('bit-categoria-modal');
            const importante = document.getElementById('bit-importante-modal');
            const recordatorio = document.getElementById('bit-recordatorio-modal');
            const fechaRec = document.getElementById('bit-fecha-recordatorio-modal');
            const btnDelete = document.getElementById('btn-delete-bitacora');

            // Reset defaults
            editId.value = '';
            contenido.value = '';
            categoria.value = 'mantenimiento';
            importante.checked = false;
            recordatorio.checked = false;
            fechaRec.value = '';
            document.getElementById('bit-reminder-date-group').style.display = 'none';

            // Reset Links
            document.querySelectorAll('input[name="bit-link-type"]').forEach(r => r.checked = (r.value === 'none'));
            toggleBitacoraLink();

            // Populate Assets Dropdown
            const assetSelect = document.getElementById('bit-link-asset-select');
            assetSelect.innerHTML = '<option value="">-- Seleccionar Equipo --</option>';
            equipos.sort((a, b) => a.nombre.localeCompare(b.nombre)).forEach(eq => {
                const op = document.createElement('option');
                op.value = eq.id; // Assuming ID is int or stable string
                op.innerText = eq.nombre;
                assetSelect.appendChild(op);
            });
            document.getElementById('bit-link-room-input').value = '';
            document.getElementById('bit-link-floor-select').value = '';

            if (id) {
                // EDIT MODE
                const ent = bitacoraDatos.find(e => e.id === id);
                if (!ent) return;

                title.innerText = 'Editar Entrada';
                editId.value = ent.id;
                contenido.value = ent.contenido;
                categoria.value = ent.categoria;
                importante.checked = ent.importante || false;

                if (ent.esRecordatorio) {
                    recordatorio.checked = true;
                    fechaRec.value = ent.fechaRecordatorio;
                    document.getElementById('bit-reminder-date-group').style.display = 'block';
                }

                // Set Link
                if (ent.assetId) {
                    const rAsset = document.querySelector('input[name="bit-link-type"][value="asset"]');
                    if (rAsset) rAsset.checked = true;
                    toggleBitacoraLink();
                    assetSelect.value = ent.assetId;
                } else if (ent.roomId) {
                    const rRoom = document.querySelector('input[name="bit-link-type"][value="room"]');
                    if (rRoom) rRoom.checked = true;
                    toggleBitacoraLink();
                    document.getElementById('bit-link-room-input').value = ent.roomId;
                }

                btnDelete.style.display = 'block';
            } else {
                // NEW MODE
                title.innerText = 'Nueva Entrada';
        ...
        function toggleBitacoraReminder() {
            const chk = document.getElementById('bit-recordatorio-modal');
            document.getElementById('bit-reminder-date-group').style.display = chk.checked ? 'block' : 'none';
        }

        function toggleBitacoraLink() {
            const typeEl = document.querySelector('input[name="bit-link-type"]:checked');
            const type = typeEl ? typeEl.value : 'none';
            document.getElementById('bit-link-asset-group').style.display = (type === 'asset') ? 'block' : 'none';
            document.getElementById('bit-link-room-group').style.display = (type === 'room') ? 'block' : 'none';
        }

        function updateBitacoraRooms() {
            // Optional helper
        }

        function saveBitacoraEntry() {
            const id = document.getElementById('bit-edit-id').value;
            const contenido = document.getElementById('bit-contenido-modal').value.trim();
            if (!contenido) return alert("⚠️ Escribe algo...");

            const categoria = document.getElementById('bit-categoria-modal').value;
            const importante = document.getElementById('bit-importante-modal').checked;
            const esRecordatorio = document.getElementById('bit-recordatorio-modal').checked;
            const fechaRec = esRecordatorio ? document.getElementById('bit-fecha-recordatorio-modal').value : null;

            if (esRecordatorio && !fechaRec) return alert("⚠️ Selecciona fecha para el recordatorio");

            // Link Data
            let assetId = null;
            let roomId = null;
            const linkTypeEl = document.querySelector('input[name="bit-link-type"]:checked');
            const linkType = linkTypeEl ? linkTypeEl.value : 'none';

            if (linkType === 'asset') {
                const val = document.getElementById('bit-link-asset-select').value;
                if (val) assetId = parseInt(val);
            } else if (linkType === 'room') {
                const floor = document.getElementById('bit-link-floor-select').value;
                const room = document.getElementById('bit-link-room-input').value.trim();
                if (room) roomId = (floor ? floor + ' - ' : '') + room;
            }
            ...
            if (id) {
                ...
                const ent = bitacoraDatos.find(e => e.id == id);
                if (ent) {
                    ent.contenido = contenido;
                    ent.categoria = categoria;
                    ent.importante = importante;
                    ent.esRecordatorio = esRecordatorio;
                    ent.fechaRecordatorio = fechaRec;
                    ent.assetId = assetId;
                    ent.roomId = roomId;
                }
            } else {
                ...
                const nuevaEntrada = {
                    ...
                    timestamp: ahora.getTime(), // Guardar como número es más robusto
                    esRecordatorio,
                    fechaRecordatorio: fechaRec,
                    completado: false,
                    importante,
                    assetId,
                    roomId
                };
                bitacoraDatos.unshift(nuevaEntrada);
            }
        ...
        function deleteBitacoraEntry() {
            const id = document.getElementById('bit-edit-id').value;
            if (!id) return;

            if (confirm("¿Estás seguro de eliminar esta entrada?")) {
                bitacoraDatos = bitacoraDatos.filter(e => e.id != id);
                saveBitacora();
                renderCurrentView();
                closeBitacoraModal();
            }
        ...
        function updateBitacoraConfig() {
            bitacoraConfig.nombre = document.getElementById('cfg-bit-nombre').value;
            bitacoraConfig.cargo = document.getElementById('cfg-bit-cargo').value;
            bitacoraConfig.empresa = document.getElementById('cfg-bit-empresa').value;
            saveBitacora();
        }

        function bitacoraPDF(tipo) {
            const { jsPDF } = window.jspdf;
            if (!jsPDF) return alert("Error: Librería PDF no cargada. Recargue la página.");
            ...
            if (tipo === 'diario') {
                ...
                entradas = bitacoraDatos.filter(e => e.fecha === hoyStr);
                titulo = `INFORME DIARIO - ${hoyStr}`;
            } else if (tipo === 'semanal') {
                const inicio = new Date();
                inicio.setDate(hoy.getDate() - 7);
                entradas = bitacoraDatos.filter(e => new Date(e.timestamp) >= inicio);
                ...
                const d = new Date();
                const day = d.getDay();
                const diffAMon = (day === 0 ? 6 : day - 1);

                const lunesP = new Date(d);
                lunesP.setDate(d.getDate() - diffAMon - 7);

                const viernesP = new Date(lunesP);
                viernesP.setDate(lunesP.getDate() + 4);
                ...
                const inicioStr = toStr(lunesP);
                const finStr = toStr(viernesP);

                // Filtramos comparando strings YYYY-MM-DD para evitar líos de UTC
                entradas = bitacoraDatos.filter(e => {
                    const f = e.fecha;
                    return f >= inicioStr && f <= finStr && e.importante;
                });

                const fmt = (s) => s.split('-').reverse().slice(0, 2).join('/');
                titulo = `RESUMEN EJECUTIVO (${fmt(inicioStr)} al ${fmt(finStr)})`;
            }

            if (entradas.length === 0) return alert("⚠️ No hay entradas para este reporte.");

            // Generación simple PDF
            doc.setFontSize(18);
            doc.text(titulo, 20, 20);

            doc.setFontSize(10);
            doc.text(`Generado por: ${bitacoraConfig.nombre} | ${bitacoraConfig.cargo}`, 20, 30);
            doc.text(`Empresa: ${bitacoraConfig.empresa}`, 20, 35);
            doc.line(20, 40, 190, 40);

            let y = 50;
            entradas.forEach((e, i) => {
                if (y > 270) { doc.addPage(); y = 20; }
                const prefix = e.importante ? "★ " : "";
                doc.setFont("helvetica", "bold");
                doc.text(`${prefix}[${e.categoria.toUpperCase()}] ${e.fecha} ${e.hora || ''}`, 20, y);
                y += 5;
                doc.setFont("helvetica", "normal");

                const splitTitle = doc.splitTextToSize(e.contenido, 170);
                doc.text(splitTitle, 20, y);
                y += (splitTitle.length * 5) + 5;
            });

            doc.save(`bitacora_${tipo}.pdf`);
        }

        function downloadBitacoraJSON() {
            const backup = {
                tipo: 'XELONIA_BITACORA_BACKUP',
                version: '1.0',
                fecha: new Date().toISOString(),
            ...
            downloadAnchorNode.setAttribute("download", "BITACORA_BACKUP_" + new Date().toISOString().split('T')[0] + ".json");
            document.body.appendChild(downloadAnchorNode); // required for firefox
            downloadAnchorNode.click();
            downloadAnchorNode.remove();
        }

        function uploadBitacoraJSON(input) {
            ...
            reader.onload = function (e) {
                try {
                    ...
                    // Validación más flexible: Permitir si tiene 'datos' y es array, o si tiene la firma nueva
                    const esFormatoNuevo = json.tipo === 'XELONIA_BITACORA_BACKUP';
                    const esFormatoLegado = Array.isArray(json.datos) && (json.version || json.fecha); // Detección básica

                    if (!esFormatoNuevo && !esFormatoLegado) {
                        throw new Error("Formato de archivo inválido. Asegúrese de usar un backup generado por esta aplicación.");
                    }

                    if (confirm(`📥 Archivo cargado: ${file.name}\n\nContiene ${json.datos.length} entradas.\n\n¿Desea FUSIONAR estos datos con los actuales? (Los duplicados se actualizarán)`)) {

                        // 1. Fusionar Configuración (Priorizar la del JSON si existe)
                        if (json.config) {
                            bitacoraConfig = { ...bitacoraConfig, ...json.config };
                        }

                        // 2. Fusionar Datos (Estrategia: ID único)
                        const currentIds = new Set(bitacoraDatos.map(d => d.id));
                        let nuevosCount = 0;
                        let actualizadosCount = 0;

                        json.datos.forEach(entry => {
                            if (currentIds.has(entry.id)) {
                                // Actualizar existente (Opcional: solo si es más reciente? Por ahora sobrescribimos para restaurar)
                                const index = bitacoraDatos.findIndex(d => d.id === entry.id);
                                bitacoraDatos[index] = entry;
                                actualizadosCount++;
                            } else {
                                // Agregar nuevo
                                bitacoraDatos.push(entry);
                                nuevosCount++;
                            }
                        });

                        // 3. Reordenar y Guardar
                        bitacoraDatos.sort((a, b) => new Date(b.timestamp || b.fecha) - new Date(a.timestamp || a.fecha));
                        saveBitacora();
                        renderCurrentView();

                        alert(`✅ Importación completada:\n\n🆕 Nuevas entradas: ${nuevosCount}\n🔄 Actualizadas: ${actualizadosCount}`);
                    }
        ...
        // --- BITÁCORA PROFESIONAL INTEGRATION ---
        const BITACORA_KEY = 'BITACORA_DATOS';
        const BITACORA_CONFIG_KEY = 'BITACORA_CONFIG';
        let bitacoraDatos = [];
        let bitacoraConfig = { nombre: '', empresa: '', cargo: '' };
        let bitacoraFiltro = 'todas';
        let bitacoraFiltroTemporal = null;
        let entradaEditando = null;

        function loadBitacora() {
            try {
                const d = localStorage.getItem(BITACORA_KEY);
                const c = localStorage.getItem(BITACORA_CONFIG_KEY);
                bitacoraDatos = d ? JSON.parse(d) : [];
                bitacoraConfig = c ? JSON.parse(c) : { nombre: 'Usuario', empresa: 'Empresa', cargo: 'Cargo' };
                console.log("📚 Bitácora cargada:", bitacoraDatos.length, "entradas");
            } catch (e) {
        ...
        function saveBitacora() {
            try {
                localStorage.setItem(BITACORA_KEY, JSON.stringify(bitacoraDatos));
                localStorage.setItem(BITACORA_CONFIG_KEY, JSON.stringify(bitacoraConfig));
            } catch (e) {
                console.error("Error saving Bitacora:", e);
                alert("Error al guardar bitácora (posible memoria llena)");
            }
        }

        // --- BITACORA MODAL LOGIC ---
        function openEditBitacora(id = null) {
            const modal = document.getElementById('modal-bitacora');
            ...
            if (id) {
                const entry = bitacoraDatos.find(b => b.id === id);
                if (entry) {
                    entradaEditando = id;
                    document.getElementById('bit-modal-title').innerText = "Editar Entrada";
                    document.getElementById('bit-edit-id').value = entry.id;
                    document.getElementById('bit-contenido-modal').value = entry.contenido;
                    document.getElementById('bit-categoria-modal').value = entry.categoria;
                    document.getElementById('bit-importante-modal').checked = entry.importante;

                    document.getElementById('bit-recordatorio-modal').checked = !!entry.recordatorio;
                    if (entry.recordatorio) {
                        document.getElementById('bit-reminder-date-group').style.display = 'block';
                        document.getElementById('bit-fecha-recordatorio-modal').value = entry.recordatorio;
                    } else {
                        document.getElementById('bit-reminder-date-group').style.display = 'none';
                    }
                    ...
                    // Linking
                    if (entry.assetId) {
                        document.querySelector('input[name="bit-link-type"][value="asset"]').checked = true;
                        toggleBitacoraLink(); // Show select
                        assetSelect.value = entry.assetId;
                    } else if (entry.roomId) {
                        document.querySelector('input[name="bit-link-type"][value="room"]').checked = true;
                        toggleBitacoraLink(); // Show inputs
                        document.getElementById('bit-link-room-input').value = entry.roomId;
                        if (entry.floor) document.getElementById('bit-link-floor-select').value = entry.floor;
                    } else {
                        document.querySelector('input[name="bit-link-type"][value="none"]').checked = true;
                        toggleBitacoraLink();
                    }

                    document.getElementById('btn-delete-bitacora').style.display = 'block';
                }
            } else {
                entradaEditando = null;
                document.getElementById('bit-modal-title').innerText = "Nueva Entrada";
                document.getElementById('bit-edit-id').value = "";
                document.getElementById('btn-delete-bitacora').style.display = 'none';

                toggleBitacoraLink();
                toggleBitacoraReminder();
            }
        ...
        function toggleBitacoraReminder() {
            const chk = document.getElementById('bit-recordatorio-modal');
            const group = document.getElementById('bit-reminder-date-group');
            group.style.display = chk.checked ? 'block' : 'none';
        }

        function toggleBitacoraLink() {
            const type = document.querySelector('input[name="bit-link-type"]:checked').value;
            document.getElementById('bit-link-asset-group').style.display = type === 'asset' ? 'block' : 'none';
            document.getElementById('bit-link-room-group').style.display = type === 'room' ? 'block' : 'none';
        }
        ...
        function saveBitacoraEntry() {
            const contenido = document.getElementById('bit-contenido-modal').value;
            const categoria = document.getElementById('bit-categoria-modal').value;
            const importante = document.getElementById('bit-importante-modal').checked;

            const recordatorioChk = document.getElementById('bit-recordatorio-modal').checked;
            const recordatorioFecha = recordatorioChk ? document.getElementById('bit-fecha-recordatorio-modal').value : null;

            const linkType = document.querySelector('input[name="bit-link-type"]:checked').value;
            let assetId = null;
            let roomId = null;
            let floor = null;
            ...
            if (linkType === 'asset') {
                ...
                roomId = document.getElementById('bit-link-room-input').value;
                floor = document.getElementById('bit-link-floor-select').value;
            }

            if (!contenido) {
                alert("Escribe un contenido para la entrada.");
                return;
            }

            if (entradaEditando) {
                // Edit existing
                const entry = bitacoraDatos.find(b => b.id === entradaEditando);
                if (entry) {
                    entry.contenido = contenido;
                    entry.categoria = categoria;
                    entry.importante = importante;
                    entry.recordatorio = recordatorioFecha;
                    entry.assetId = assetId;
                    entry.roomId = roomId;
                    entry.floor = floor;
                    entry.fechaEdicion = new Date().toISOString();
                }
            } else {
                // New
                const newEntry = {
                    id: Date.now(),
                    fecha: new Date().toISOString(),
                    usuario: currentUser ? currentUser.nombre : 'Usuario',
                    contenido: contenido,
                    categoria: categoria,
                    importante: importante,
                    recordatorio: recordatorioFecha,
                    assetId: assetId,
                    roomId: roomId,
                    floor: floor
                };
                bitacoraDatos.unshift(newEntry);
            }
        ...
        function deleteBitacoraEntry() {
            ...
            if (confirm("¿Eliminar esta entrada de la bitácora?")) {
                bitacoraDatos = bitacoraDatos.filter(b => b.id !== entradaEditando);
                saveBitacora(); // Saves to localStorage
                persist();      // Force global persist if needed
                closeBitacoraModal();
                renderBitacora();
                if (typeof renderCurrentView === 'function') renderCurrentView(); // Force global refresh
                alert("🗑️ Entrada eliminada.");
            }
        }
        // --- END BITÁCORA INTEGRATION ---
        ...
        currentGanttDate.setDate(currentGanttDate.getDate() - 2); // Init: Start a bit before today

        function prevGantt() {
            currentGanttDate.setDate(currentGanttDate.getDate() - 14);
            renderCurrentView();
        }
        ...
        function renderGantt() {
            ...
            // Exclude 'completada' status
            const scheduled = ots.filter(o =>
                (o.tipo === 'programado' || o.tipo === 'preventivo') &&
                o.estado !== 'completada'
            );

            // 2. Setup Timeline Params
            const startDate = new Date(currentGanttDate);
            const daysToShow = 14;
            const timelineDates = [];
            ...
            const cols = timelineDates.map(d => {
                ...
                const monthName = d.getDate() === 1 ? d.toLocaleDateString('es-CL', { month: 'short' }).toUpperCase() : '';

                return `
            <div style="text-align: center; border-right: 1px solid var(--color-border); padding: 5px; background: ${isToday ? 'rgba(59, 130, 246, 0.2)' : 'transparent'}; position: relative;">
                ...
                ${monthName ? `<div style="position: absolute; top: -15px; left: 0; right: 0; font-size: 0.6rem; color: var(--color-primary); font-weight: 800;">${monthName}</div>` : ''}
            </div>
        `;
            }).join('');
            ...
            const rows = scheduled.map(task => {
                ...
                // We render tasks even if they start before the view but overlap into it, or start within view

                const gridStart = diffDays + 1;
                const gridEnd = gridStart + duration;

                // Visibility Check: 
                // Visible if end > 0 (starts before but ends inside or after) 
                // AND start < daysToShow (starts inside)
                if (gridEnd <= 1 || gridStart > daysToShow + 1) return '';

                // Clamp visual bars to the view
                const visualStart = Math.max(1, gridStart);
                const visualEnd = Math.min(daysToShow + 1, gridEnd);

                // If effective width is <= 0 after clamping, don't render bar
                if (visualEnd <= visualStart) return '';

                const eqName = task.roomId ? ("Habitación " + task.roomId) : (equipos.find(e => e.id === task.equipoId)?.nombre || "Equipo General");
                const tecName = tecnicos.find(t => t.id === task.asignadoId)?.nombre || "Sin Asignar";

                const progresoValue = task.progreso || 0;

                // Color por prioridad
                let colorBar = 'var(--color-primary)';
                if (task.prioridad === 'URGENTE') colorBar = 'var(--color-danger)';
                if (task.prioridad === 'ALTA') colorBar = 'var(--color-warning)';
                if (task.prioridad === 'BAJA') colorBar = 'var(--color-success)';

                // Fondo semitransparente
                let barBg = 'rgba(59, 130, 246, 0.2)';
                if (task.prioridad === 'URGENTE') barBg = 'rgba(239, 68, 68, 0.2)';
                if (task.prioridad === 'ALTA') barBg = 'rgba(245, 158, 11, 0.2)';
                if (task.prioridad === 'BAJA') barBg = 'rgba(16, 185, 129, 0.2)';

                const etapas = task.etapas || [];
                const etapasCompletas = etapas.filter(e => e.completa).length;
                const etapasInfo = etapas.length > 0 ? ` [${etapasCompletas}/${etapas.length}]` : '';

                return `
            <div style="display: contents;">
                <div onclick="openGanttModal(${task.id})" style="padding: 10px; border-bottom: 1px solid var(--color-border); font-size: 0.8rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer;">
                    <div style="font-weight: bold; color: white;">${task.titulo}${etapasInfo}</div>
                ...
                <div style="grid-column: 1 / span ${daysToShow}; display: grid; grid-template-columns: repeat(${daysToShow}, 1fr); align-items: center; border-bottom: 1px solid var(--color-border); position: relative; height: 50px;">
                    ...
                    <!-- Task Bar Container -->
                    <div onclick="openGanttModal(${task.id})" style="
                        grid-column: ${gridStart} / ${gridEnd}; 
                        background: ${barBg}; 
                        height: 24px; 
                        border: 1px solid ${colorBar.replace('var(--color-', 'rgba(var(--color-').replace(')', ', 0.3)')};
                        border-radius: 4px; 
                        position: absolute; 
                        top: 13px; 
                        left: 2px; 
                        ...
                        z-index: 10;
                    ">
                        <div style="width: ${progresoValue}%; height: 100%; background: ${colorBar}; opacity: 0.8;"></div>
                        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; display: flex; align-items: center; padding: 0 8px; font-size: 0.7rem; font-weight: bold; text-shadow: 0 1px 2px black; pointer-events: none; color: white;">
                            ${duration > 1 ? task.titulo : ''} ${progresoValue > 0 ? `(${progresoValue}%)` : ''}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="view-content">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                <div>
                    ...
                    <div style="display: flex; gap: 15px; margin-top: 5px; font-size: 0.7rem;">
                        ...
                        <span style="display: flex; align-items: center; gap: 4px;"><span style="width: 10px; height: 10px; border-radius: 2px; background: var(--color-primary);"></span> Media</span>
                        <span style="display: flex; align-items: center; gap: 4px;"><span style="width: 10px; height: 10px; border-radius: 2px; background: var(--color-success);"></span> Baja</span>
                    </div>
                </div>
                <div style="display: flex; gap: 10px; align-items: center;">
                    <div style="display: flex; background: rgba(0,0,0,0.3); border-radius: 8px; padding: 2px;">
                        <button class="btn" style="padding: 5px 10px; background: transparent;" onclick="prevGantt()"><span class="material-symbols-rounded">chevron_left</span></button>
                        <span style="padding: 5px 10px; font-size: 0.8rem; font-weight: bold; display: flex; align-items: center;">${rangeStr}</span>
                        <button class="btn" style="padding: 5px 10px; background: transparent;" onclick="nextGantt()"><span class="material-symbols-rounded">chevron_right</span></button>
                    </div>
            ...
            <div class="card" style="padding: 0; overflow-x: auto;">
                ...
                ${rows.length === 0 ? '<div style="padding: 20px; text-align: center; color: var(--color-text-muted);">No hay tareas programadas para este período.</div>' : ''}
            </div>
        </div>
    `;
        }
        ...
        function renderCalendario() {
            const now = new Date(currentCalendarDate);
            ...
            let calendarHtml = `<div class="view-content">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3>Calendario de Mantenimiento</h3>
                    <div style="display: flex; gap: 10px; align-items: center;">
                        <button class="btn" style="padding: 5px 10px;" onclick="prevMonth()"><span class="material-symbols-rounded">chevron_left</span></button>
                        <span style="font-weight: bold; font-size: 1.1rem; min-width: 150px; text-align: center;">${monthNames[month]} ${year}</span>
                        <button class="btn" style="padding: 5px 10px;" onclick="nextMonth()"><span class="material-symbols-rounded">chevron_right</span></button>
                    </div>
                </div>
                
                <div class="card" style="padding: 0; overflow: hidden;">
                    <div style="display: grid; grid-template-columns: repeat(7, 1fr); background: rgba(0,0,0,0.2); border-bottom: 1px solid var(--color-border);">
                        ${dayLabels.map(day => `<div style="padding: 10px; text-align: center; font-size: 0.7rem; font-weight: bold; color: var(--color-text-muted); text-transform: uppercase;">${day}</div>`).join('')}
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(7, 1fr); grid-auto-rows: minmax(100px, auto);">
            `;

            for (let i = 0; i < firstDay; i++) {
                calendarHtml += `<div style="border-right: 1px solid var(--color-border); border-bottom: 1px solid var(--color-border); background: rgba(255,255,255,0.02);"></div>`;
            }

            // Real "Typical" Today for highlighting
            const realToday = new Date();
            const isSameMonth = realToday.getMonth() === month && realToday.getFullYear() === year;

            for (let day = 1; day <= daysInMonth; day++) {
                const dateStr = `${year}-${String(month + 1).padStart(2, '0')}-${String(day).padStart(2, '0')}`;

                // Filter OTs by date (handling timezone or string comparison carefully)
                // Use simple string matching for 'YYYY-MM-DD'
                const dayOTs = ots.filter(o => o.fechaCreacion && o.fechaCreacion.startsWith(dateStr));

                const isToday = isSameMonth && day === realToday.getDate();

                calendarHtml += `
                    <div style="border-right: 1px solid var(--color-border); border-bottom: 1px solid var(--color-border); padding: 5px; min-height: 100px; background: ${isToday ? 'rgba(59, 130, 246, 0.05)' : 'transparent'};">
                        <div style="text-align: right; font-size: 0.8rem; font-weight: ${isToday ? 'bold' : 'normal'}; color: ${isToday ? 'var(--color-primary)' : 'var(--color-text-muted)'}; margin-bottom: 5px;">
                            ${day}
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 3px;">
                            ${dayOTs.map(ot => `
                                <div onclick="openGanttModal(${ot.id})" style="font-size: 0.6rem; padding: 2px 5px; border-radius: 3px; background: ${ot.prioridad === 'ALTA' ? 'rgba(239, 68, 68, 0.2)' : 'rgba(59, 130, 246, 0.2)'}; color: ${ot.prioridad === 'ALTA' ? 'var(--color-danger)' : 'var(--color-primary)'}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer; border-left: 2px solid ${ot.prioridad === 'ALTA' ? 'var(--color-danger)' : 'var(--color-primary)'};">
                                    ${ot.titulo}
                                </div>
                            `).join('')}
                        </div>
        ...
        function openGanttModal(taskId = null) {
            const modal = document.getElementById('modal-gantt-task');
            const title = document.getElementById('gantt-modal-title');

            // Poblar selects
            const eqSelect = document.getElementById('gantt-task-equipo');
            const tecSelect = document.getElementById('gantt-task-tec');

            eqSelect.innerHTML = equipos.map(e => `<option value="${e.id}">${e.nombre}</option>`).join('');
            tecSelect.innerHTML = tecnicos.map(t => `<option value="${t.id}">${t.nombre}</option>`).join('');

            // Default View: Equipment
            document.querySelector('input[name="gantt-asset-type"][value="equipment"]').checked = true;
            toggleGanttAssetType('equipment');
            const btnDelete = document.getElementById('btn-delete-gantt');
            const form = document.getElementById('gantt-task-form');


            form.reset();
            document.getElementById('gantt-photo-preview').style.display = 'none';
            form.reset();
            document.getElementById('gantt-photo-preview').style.display = 'none';
            btnDelete.style.display = taskId ? 'block' : 'none';

            // Show Finish button only if editing and not already completed
            const btnFinish = document.getElementById('btn-finish-gantt');
            if (btnFinish) btnFinish.style.display = 'none';

            if (taskId) {
                const task = ots.find(o => o.id == taskId);
                if (task) {
                    title.innerText = "Editar Tarea Gantt";
                    document.getElementById('gantt-task-id').value = task.id;
                    document.getElementById('gantt-task-title').value = task.titulo;

                    if (task.roomId) {
                        toggleGanttAssetType('room');
                        document.getElementById('gantt-task-equipo').value = task.roomId;
                    } else {
                        toggleGanttAssetType('equipment');
                        document.getElementById('gantt-task-equipo').value = task.equipoId || "";
                    }

                    document.getElementById('gantt-task-tec').value = task.asignadoId || "";
                    document.getElementById('gantt-task-start').value = task.fechaCreacion ? task.fechaCreacion.split('T')[0] : "";
                    document.getElementById('gantt-task-end').value = task.fechaFin || "";
                    document.getElementById('gantt-task-notes').value = task.descripcion || "";
                    document.getElementById('gantt-task-priority').value = task.prioridad || "MEDIA";
                    document.getElementById('gantt-task-status').value = task.estado || "pendiente";
                    document.getElementById('gantt-task-progress').value = task.progreso || 0;
                    document.getElementById('gantt-progress-val').innerText = task.progreso || 0;

                    if (task.foto_referencia) {
                        document.getElementById('gantt-preview-img').src = task.foto_referencia;
                        document.getElementById('gantt-photo-preview').style.display = 'block';
                    }

                    if (btnFinish && task.estado !== 'completada') {
                        btnFinish.style.display = 'block';
                    }

                    renderEtapasModal(task.etapas || []);
                }
            } else {
                title.innerText = "Programar Tarea Gantt";
                document.getElementById('gantt-task-id').value = "";
                toggleGanttAssetType('equipment'); // Default
                document.getElementById('gantt-task-equipo').value = "";
                document.getElementById('gantt-task-start').value = new Date().toISOString().split('T')[0];
                document.getElementById('gantt-task-priority').value = "MEDIA";
                document.getElementById('gantt-task-status').value = "pendiente";
                document.getElementById('gantt-task-progress').value = 0;
                document.getElementById('gantt-progress-val').innerText = 0;
                renderEtapasModal([]);
            }
            modal.style.display = 'flex';
        }

        let currentModalEtapas = [];

        function renderEtapasModal(etapas = []) {
            currentModalEtapas = JSON.parse(JSON.stringify(etapas));
            const container = document.getElementById('gantt-etapas-container');
            if (!container) return;
        ...
        function addEtapa() {
            currentModalEtapas.push({ texto: '', completa: false });
            refreshEtapasList();
            updateProgressFromEtapas();
        }

        function removeEtapa(index) {
            currentModalEtapas.splice(index, 1);
            refreshEtapasList();
            updateProgressFromEtapas();
        }

        function toggleEtapa(index) {
            currentModalEtapas[index].completa = !currentModalEtapas[index].completa;
            updateProgressFromEtapas();
        }

        function updateProgressFromEtapas() {
            if (currentModalEtapas.length === 0) return;
            const completas = currentModalEtapas.filter(e => e.completa).length;
            const progress = Math.round((completas / currentModalEtapas.length) * 100);
            document.getElementById('gantt-task-progress').value = progress;
            document.getElementById('gantt-progress-val').innerText = progress;
        }

        function refreshEtapasList() {
            const container = document.getElementById('gantt-etapas-container');
            container.innerHTML = currentModalEtapas.map((e, i) => `
                <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 5px; background: rgba(255,255,255,0.03); padding: 5px; border-radius: 4px;">
                    <input type="checkbox" ${e.completa ? 'checked' : ''} onchange="toggleEtapa(${i})" style="width: 18px; height: 18px; cursor: pointer;">
                    <input type="text" value="${e.texto}" oninput="currentModalEtapas[${i}].texto = this.value" 
                           placeholder="Descripción de la etapa..." class="form-control" style="flex: 1; padding: 4px 8px; font-size: 0.75rem;">
                    <button type="button" onclick="removeEtapa(${i})" class="btn" style="padding: 4px; color: var(--color-danger); background: transparent;">
        ...
        function closeGanttModal() {
            document.getElementById('modal-gantt-task').style.display = 'none';
        }

        function previewGanttPhoto(event) {
            const reader = new FileReader();
            reader.onload = function () {
                const preview = document.getElementById('gantt-photo-preview');
                const img = document.getElementById('gantt-preview-img');
        ...
        function saveGanttTask() {
            try {
                const id = document.getElementById('gantt-task-id').value;
                const title = document.getElementById('gantt-task-title').value;

                // New Logic for Asset/Room
                let assetType = 'equipment';
                const radio = document.querySelector('input[name="gantt-asset-type"]:checked');
                if (radio) {
                    assetType = radio.value;
                } else {
                    // Fallback: check based on visibility or default
                    assetType = 'equipment';
                }
                const selectedVal = document.getElementById('gantt-task-equipo').value;

                let eqId = null;
                let roomId = null;

                if (assetType === 'equipment') {
                    eqId = parseInt(selectedVal);
                } else {
                    roomId = selectedVal; // String (e.g. "101")
                }

                const tecId = parseInt(document.getElementById('gantt-task-tec').value);
                const start = document.getElementById('gantt-task-start').value;
                const end = document.getElementById('gantt-task-end').value;
                const notes = document.getElementById('gantt-task-notes').value;
                const photo = document.getElementById('gantt-preview-img').src;

                const tec = tecnicos.find(t => t.id === tecId);

                const priority = document.getElementById('gantt-task-priority').value;
                const status = document.getElementById('gantt-task-status').value;
                const progress = parseInt(document.getElementById('gantt-task-progress').value);

                if (id) {
                    const task = ots.find(o => o.id == id);
                    if (task) {
                        task.titulo = title;
                        task.equipoId = eqId;
                        task.roomId = roomId; // New field
                        task.asignadoId = tecId;
                        task.asignadoNombre = tec ? tec.nombre : "";
                        task.fechaCreacion = start;
                        task.fechaFin = end;
                        task.descripcion = notes;
                        task.prioridad = priority;
                        task.estado = status;
                        task.progreso = progress;
                        task.etapas = currentModalEtapas.filter(e => e.texto.trim() !== '');
                        if (photo.startsWith('data:image')) task.foto_referencia = photo;

                        if (end) {
                            const d1 = new Date(start);
                            const d2 = new Date(end);
                            task.duracionDias = Math.max(1, Math.ceil((d2 - d1) / (1000 * 60 * 60 * 24)) + 1);
                        } else {
                            task.duracionDias = 1;
                        }
                    }
                    ...
                    const newTask = {
                        ...
                        titulo: title,
                        equipoId: eqId,
                        roomId: roomId, // New field
                        asignadoId: tecId,
                        asignadoNombre: tec ? tec.nombre : "",
                        fechaCreacion: start,
                        fechaFin: end,
                        descripcion: notes,
                        tipo: 'programado',
                        prioridad: priority,
                        progreso: progress,
                        etapas: currentModalEtapas.filter(e => e.texto.trim() !== ''),
                        estado: status,
                        foto_referencia: photo.startsWith('data:image') ? photo : null
                    };

                    if (end) {
                        const d1 = new Date(start);
                        const d2 = new Date(end);
                        newTask.duracionDias = Math.max(1, Math.ceil((d2 - d1) / (1000 * 60 * 60 * 24)) + 1);
                    } else {
                        newTask.duracionDias = 1;
                    }
                    ots.push(newTask);
                }
        ...
        function finishGanttTask() {
            if (!confirm("¿Confirmar que la tarea está COMPLETADA? \n\nSe marcará con 100% de avance y desaparecerá del gráfico.")) return;

            document.getElementById('gantt-task-status').value = 'completada';
            document.getElementById('gantt-task-progress').value = 100;
            document.getElementById('gantt-progress-val').innerText = '100';

            saveGanttTask();
        }

        function confirmDeleteGanttTask() {
            if (confirm("¿Estás seguro de eliminar esta tarea programada?")) {
                const id = document.getElementById('gantt-task-id').value;
                deleteGanttTask(id);
            }
        }
        ...
        function toggleGanttAssetType(type) {
            const select = document.getElementById('gantt-task-equipo');
            const label = document.getElementById('lbl-gantt-target');
            const btnAdd = document.getElementById('btn-add-area-gantt');

            // Update Radio UI (if called programmatically)
            document.querySelectorAll('input[name="gantt-asset-type"]').forEach(r => {
                if (r.value === type) r.checked = true;
            });

            if (type === 'equipment') {
                label.innerText = "Equipo / Activo";
                select.innerHTML = equipos.map(e => `<option value="${e.id}">${e.nombre}</option>`).join('');
                if (btnAdd) btnAdd.style.display = 'none';
            } else {
                label.innerText = "Habitación / Área";
                // Merge movements and custom areas
                const uniqueRooms = [...new Set(registroHabitaciones.map(r => r.habitacion))];
                const allAreas = [...new Set([...uniqueRooms, ...customAreas])].sort((a, b) => {
                    return a.localeCompare(b, undefined, { numeric: true, sensitivity: 'base' });
                });

                select.innerHTML = allAreas.map(r => `<option value="${r}">${r}</option>`).join('');
                if (btnAdd) btnAdd.style.display = 'block';
            }
        }

        function addCustomArea() {
            const name = prompt("Nombre del nuevo Lugar / Área (ej: Salón de Eventos):");
            if (name && name.trim() !== "") {
                const cleanName = name.trim();
                if (!customAreas.includes(cleanName)) {
                    customAreas.push(cleanName);
                    persist();
                    alert("✅ Área guardada: " + cleanName);
                    // Refresh dropdown
                    toggleGanttAssetType('room');
                    // Select it
                    document.getElementById('gantt-task-equipo').value = cleanName;
                } else {
        ...
        // --- ROOM REGISTRATION MODULE ---
        let currentRoomFilter = 'all'; // 'all', 'tomada', 'entregada'

        function setRoomFilter(filter) {
            currentRoomFilter = (currentRoomFilter === filter) ? 'all' : filter;
            renderCurrentView();
        }

        function renderRoomRow(r) {
            try {
                const idSafe = JSON.stringify(r.id);
                const habSafe = JSON.stringify(r.habitacion || '');
                const piso = (r.piso || '').startsWith('S') ? (r.piso || '') : 'P' + (r.piso || '?');
                const trabajosTxt = (Array.isArray(r.trabajos) ? r.trabajos : []).join(', ');
                // Escape detalleOtros to avoid breaking templates
                const detalle = (r.detalleOtros || '').replace(/</g, '&lt;').replace(/>/g, '&gt;');
                const detallHtml = detalle ? `<br><small style="color: var(--color-primary);">(${detalle})</small>` : '';
                const tipoBg = r.tipo === 'tomada' ? 'rgba(245,158,11,0.2)' : 'rgba(16,185,129,0.2)';
                const tipoColor = r.tipo === 'tomada' ? 'var(--color-warning)' : 'var(--color-success)';
                return `
                    <div style="display: grid; grid-template-columns: 60px 60px 100px 1fr 140px 150px 90px; border-bottom: 1px solid var(--color-border); padding: 12px 10px; font-size: 0.8rem; align-items: center;">
                        <span style="font-weight: bold;">${piso}</span>
                        <span style="font-size: 1rem; color: white; font-weight: 800;">${r.habitacion || ''}</span>
                        <span class="role-badge" style="background: ${tipoBg}; color: ${tipoColor}; width: fit-content; border: 1px solid;">
                            ${(r.tipo || '').toUpperCase()}
                        </span>
                        <span style="font-size: 0.7rem; color: var(--color-text-muted);">
                            ${trabajosTxt}${detallHtml}
                        </span>
                        <span style="font-size: 0.75rem;">${r.tecnicoNombre || 'Sin Asignar'}</span>
                        <span style="font-size: 0.7rem; color: var(--color-text-muted);">${new Date(r.fecha).toLocaleString()}</span>
                        <div style="display: flex; gap: 4px; flex-wrap: wrap;">
                            <button onclick="openRoomHistory(${habSafe})" class="btn" style="padding: 4px; min-width: auto; background: rgba(16,185,129,0.1); color: var(--color-success);" title="Ver Historial">
                                <span class="material-symbols-rounded" style="font-size: 16px;">history</span>
                            </button>
                            <button onclick="editHabitacion(${idSafe})" class="btn" style="padding: 4px; min-width: auto; background: rgba(59,130,246,0.1); color: var(--color-primary);" title="Editar">
                                <span class="material-symbols-rounded" style="font-size: 16px;">edit</span>
                            </button>
                            <button onclick="deleteHabitacion(${idSafe})" class="btn" style="padding: 4px; min-width: auto; background: rgba(239,68,68,0.1); color: var(--color-danger);" title="Eliminar">
                                <span class="material-symbols-rounded" style="font-size: 16px;">delete</span>
                            </button>
                        </div>
                    </div>`;
            } catch (e) {
                console.error('[renderRoomRow]', e, r);
                return `<div style="padding:8px; color: var(--color-danger); font-size:0.75rem;">⚠️ Error al mostrar fila: ${e.message}</div>`;
            }
        }

        function renderHabitaciones() {
            const tomadas = registroHabitaciones.filter(r => r.tipo === 'tomada');
            const entregadas = registroHabitaciones.filter(r => r.tipo === 'entregada');

            // Sorting naturally (numerical)
            let displayList = registroHabitaciones.slice().sort((a, b) => {
                // Try parse numbers
            ...
            if (currentRoomFilter !== 'all') {
                displayList = displayList.filter(r => r.tipo === currentRoomFilter);
            }

            // Banner Title
            let filterTitle = 'Todas las Habitaciones';
            if (currentRoomFilter === 'tomada') filterTitle = 'Filtrado: Habitaciones Tomadas';
            if (currentRoomFilter === 'entregada') filterTitle = 'Filtrado: Habitaciones Entregadas';
            ...
            return `
                <div class="view-content">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ${currentRoomFilter !== 'all' ? `<button class="btn" onclick="setRoomFilter('all')" style="background: rgba(255,255,255,0.1);">Ver Todas</button>` : ''}
                            <button class="btn btn-primary" onclick="openHabitacionModal()">+ Registrar Movimiento</button>
                        </div>
                    </div>

                    <div class="dashboard-grid" style="grid-template-columns: 1fr 1fr; margin-bottom: 2rem;">
                        <div class="card" onclick="setRoomFilter('tomada')" style="text-align: center; border-left: 4px solid var(--color-warning); cursor: pointer; transition: all 0.2s; ${currentRoomFilter === 'tomada' || currentRoomFilter === 'all' ? 'opacity: 1;' : 'opacity: 0.4;'}">
                            <div style="font-size: 2rem; font-weight: 800; color: var(--color-warning);">${tomadas.length}</div>
                            <div style="font-size: 0.8rem; color: var(--color-text-muted);">TOMADAS (Click filtrar)</div>
                        </div>
                        <div class="card" onclick="setRoomFilter('entregada')" style="text-align: center; border-left: 4px solid var(--color-success); cursor: pointer; transition: all 0.2s; ${currentRoomFilter === 'entregada' || currentRoomFilter === 'all' ? 'opacity: 1;' : 'opacity: 0.4;'}">
                            <div style="font-size: 2rem; font-weight: 800; color: var(--color-success);">${entregadas.length}</div>
                            <div style="font-size: 0.8rem; color: var(--color-text-muted);">ENTREGADAS (Click filtrar)</div>
                        </div>
                    </div>

                    <div class="card" style="padding: 0; overflow: hidden;">
                        <div style="padding: 10px; background: rgba(0,0,0,0.3); color: var(--color-primary); font-size: 0.8rem; font-weight: bold; text-transform: uppercase;">
                            ${filterTitle} (${displayList.length})
                        </div>
                        <div style="padding: 10px; background: rgba(0,0,0,0.2); border-bottom: 1px solid var(--color-border); font-size: 0.7rem; font-weight: bold; display: grid; grid-template-columns: 60px 60px 100px 1fr 140px 150px 90px;">
                            <span>PISO</span>
                            <span>HAB</span>
                            <span>TIPO</span>
                            <span>TRABAJOS</span>
                        ...
                        <div style="max-height: 400px; overflow-y: auto;">
                            ${displayList.map(r => renderRoomRow(r)).join('')}
                            ${displayList.length === 0 ? '<div style="padding: 2rem; text-align: center; color: var(--color-text-muted);">No hay registros en este filtro.</div>' : ''}
                        </div>
                    </div>
                </div>
            `;
        ...
        function openHabitacionModal(id = null) {
            const modal = document.getElementById('modal-room-reg');
            const form = document.getElementById('room-form');
            form.reset();

            // Poblar select de técnicos
            const tecSelect = document.getElementById('room-tecnico');
            tecSelect.innerHTML = '<option value="">Seleccionar Técnico...</option>' +
                tecnicos.map(t => `<option value="${t.id}">${t.nombre}</option>`).join('');

            if (id) {
                const r = registroHabitaciones.find(x => x.id == id);
                if (r) {
                    document.getElementById('room-edit-id').value = r.id;
                    document.getElementById('room-piso').value = r.piso;
                    document.getElementById('room-id').value = r.habitacion;
                    document.getElementById('room-type').value = r.tipo;
                    document.getElementById('room-tecnico').value = r.tecnicoId || '';

                    // Marcar trabajos
                    document.querySelectorAll('.work-item').forEach(cb => {
                        cb.checked = r.trabajos.includes(cb.value);
                    });

                    document.getElementById('work-otros-detail').value = r.detalleOtros || '';
                }
            } else {
        ...
        function editHabitacion(id) {
            openHabitacionModal(id);
        }

        function deleteHabitacion(id) {
            if (confirm("¿Estás seguro de eliminar este registro?")) {
                registroHabitaciones = registroHabitaciones.filter(r => r.id !== id);
                localStorage.setItem('cmms_habitaciones', JSON.stringify(registroHabitaciones));
                persist();
                renderCurrentView();
            }
        }
        ...
        function closeHabitacionModal() {
            document.getElementById('modal-room-reg').style.display = 'none';
        }

        function toggleOtrosDetail() {
            const otrosCheck = document.getElementById('work-otros');
            const detailContainer = document.getElementById('otros-detail-container');
            detailContainer.style.display = otrosCheck.checked ? 'block' : 'none';
        }

        function saveHabitacion() {
            const editId = document.getElementById('room-edit-id').value;
            const piso = document.getElementById('room-piso').value;
            const hab = document.getElementById('room-id').value;
            const tipo = document.getElementById('room-type').value;
            const tecId = document.getElementById('room-tecnico').value;
            const tecNombre = tecnicos.find(t => t.id == tecId)?.nombre || 'Sin Asignar';

            const trabajos = [];
            document.querySelectorAll('.work-item:checked').forEach(cb => {
                trabajos.push(cb.value);
            });

            if (trabajos.length === 0) {
                alert("⚠️ Selecciona al menos un trabajo.");
                return;
            }

            if (editId) {
                const idx = registroHabitaciones.findIndex(r => r.id == editId);
                if (idx !== -1) {
                    registroHabitaciones[idx] = {
                        ...registroHabitaciones[idx],
                        piso: piso,
                        habitacion: hab,
                        tipo: tipo,
                        ...
                        detalleOtros: document.getElementById('work-otros-detail').value,
                        fecha: new Date().toISOString()
                    };
                }
            } else {
                ...
                registroHabitaciones.push(registro);
            }
        ...
        // --- ROOM HISTORY MODAL ---
        function openRoomHistory(roomNumber) {
            const modal = document.getElementById('modal-room-history');
            const container = document.getElementById('room-history-content');
            document.getElementById('room-history-title').innerText = `Historial Habitación ${roomNumber}`;

            // 1. Movements
            const movements = registroHabitaciones.filter(r => r.habitacion == roomNumber).map(r => ({
                fecha: new Date(r.fecha),
                type: 'movimiento',
                title: r.tipo === 'tomada' ? 'HABITACIÓN TOMADA' : 'HABITACIÓN ENTREGADA',
                desc: `Trabajos: ${r.trabajos.join(', ')}` + (r.detalleOtros ? ` (${r.detalleOtros})` : ''),
                tech: r.tecnicoNombre,
                color: r.tipo === 'tomada' ? 'var(--color-warning)' : 'var(--color-success)'
            }));

            // 2. Gantt Tasks
            const tasks = ots.filter(o => o.roomId == roomNumber).map(o => ({
                fecha: new Date(o.fechaCreacion),
                type: 'gantt',
                title: 'TAREA PROGRAMADA: ' + o.titulo,
                desc: o.descripcion,
                tech: o.asignadoNombre,
                color: 'var(--color-primary)'
            }));

            // 3. Bitácora
            const bitacoras = bitacoraDatos.filter(b => b.roomId == roomNumber).map(b => ({
                fecha: new Date(b.fecha),
                type: 'bitacora',
                title: 'BITÁCORA (' + b.categoria.toUpperCase() + ')',
                desc: b.contenido,
                tech: b.usuario,
                color: 'var(--color-accent)'
            }));

            const combined = [...movements, ...tasks, ...bitacoras].sort((a, b) => b.fecha - a.fecha);

            if (combined.length === 0) {
                container.innerHTML = '<div style="padding: 2rem; text-align: center; color: var(--color-text-muted);">No hay registros históricos para esta habitación.</div>';
            } else {
                container.innerHTML = combined.map(item => `
                    <div style="border-left: 3px solid ${item.color}; background: rgba(255,255,255,0.02); padding: 12px; margin-bottom: 10px; border-radius: 0 4px 4px 0;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                            <span style="font-weight: 800; font-size: 0.75rem; color: ${item.color};">${item.title}</span>
                            <span style="font-size: 0.65rem; color: var(--color-text-muted);">${item.fecha.toLocaleString()}</span>
                        </div>
                        <div style="font-size: 0.85rem; color: #e2e8f0; margin-bottom: 5px;">${item.desc || 'Sin descripción'}</div>
                        <div style="font-size: 0.7rem; color: var(--color-text-muted); font-style: italic;">Por: ${item.tech || 'Desconocido'}</div>
                    </div>
                `).join('');
            }
        ...
        function closeRoomHistoryModal() {
            document.getElementById('modal-room-history').style.display = 'none';
        }
        ...
        function renderContratistas() {
            ...
            // Dynamic Providers Database
            const providersList = proveedores;
            ...
            const list = externalOTs.length === 0 ? '<div style="text-align: center; color: var(--color-text-muted); padding: 2rem;">No hay trabajos externos activos.</div>' :
                externalOTs.map(ot => {
                    const eq = equipos.find(e => e.id === ot.equipoId);
                    const provider = providersList.find(p => p.service === (eq.especialidad === 'Clima' ? 'Climatización' : (eq.especialidad.includes('Mec') ? 'Ascensores Schindler' : 'Calderas Chile'))) || providersList[0] || { name: 'Empresa Externa' };
        ...
        <div class="view-content">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 10px; margin-bottom: 20px;">
                ${providersList.map(p => `
                    <div class="card" style="text-align: center; padding: 15px; position: relative;">
                        <button onclick="confirmDeleteProveedor('${p.name}')" 
                                style="position: absolute; top: 10px; right: 10px; background: rgba(239, 68, 68, 0.1); color: var(--color-danger); border: none; border-radius: 4px; padding: 5px; cursor: pointer;"
                                title="Eliminar Registro">
                            <span class="material-symbols-rounded" style="font-size: 18px;">delete</span>
                        </button>
                        <div style="font-weight: bold; font-size: 1.1rem; margin-top: 10px;">${p.name}</div>
                        <div style="font-size: 0.8rem; color: var(--color-text-muted); margin: 5px 0;">${p.service}</div>
                        <div style="color: gold; font-size: 0.9rem;">★ ${p.rating}</div>
                    </div>
                `).join('')}
            </div>
    ...
    `;
        ...
        function confirmDeleteProveedor(name) {
            if (confirm(`¿Estás seguro de eliminar el registro de la empresa "${name}"?\n\nEsta acción no afectará los historiales de mantenimiento.`)) {
                proveedores = proveedores.filter(p => p.name !== name);
                persist();
                renderCurrentView();
                alert(`🗑️ Empresa "${name}" eliminada.`);
            }
        }
        ...
        function openModal(eq = null) {
            ...
            if (eq) {
                ...
                // Set Type
                if (document.getElementById('eq-tipo')) document.getElementById('eq-tipo').value = eq.tipo || "equipo";
                ...
                document.getElementById('eq-id').value = "";
                document.getElementById('eq-nombre').value = "";
                if (document.getElementById('eq-tipo')) document.getElementById('eq-tipo').value = "equipo";
                document.getElementById('eq-area').value = "";
                document.getElementById('eq-valor-mercado').value = "";
                document.getElementById('eq-valor-adq').value = "";
        ...
        function openDetails(id) {
            ...
            // Renderizar Historial Dinámico + Bitácora Linked
            const histContainer = document.getElementById('det-historial');

            // 1. Filter Bitácora for this asset
            // 1. Filter Bitácora for this asset
            // DEBUG: Check types if not matching
            const linkedBitacora = bitacoraDatos.filter(b => {
                // Loose equality to catch string vs int differences
                return b.assetId == eq.id;
            }).map(b => ({
                fecha: new Date(b.fecha).toLocaleDateString('es-ES', { day: '2-digit', month: 'short', year: 'numeric' }),
                tarea: 'BITÁCORA (' + b.categoria.toUpperCase() + ')',
                desc: b.contenido,
                tecnico: b.usuario || 'Usuario',
                isBitacora: true,
                rawDate: new Date(b.fecha)
            }));

            // 2. Filter OTs (Gantt Tasks) for this asset
            const linkedOTs = ots.filter(o => o.equipoId == eq.id).map(o => ({
                fecha: new Date(o.fechaCreacion).toLocaleDateString('es-ES', { day: '2-digit', month: 'short', year: 'numeric' }),
                tarea: (o.tipo === 'programado' ? 'GANTT: ' : 'OT: ') + o.titulo,
                desc: o.descripcion || 'Sin descripción',
                tecnico: o.asignadoNombre || 'Sin Asignar',
                estado: o.estado,
                isBitacora: false,
                isOT: true,
            ...
            // 3. Normalize existing history
            const existingHistorial = (eq.historial || []).map(h => ({
                ...h,
                isBitacora: false,
                isOT: false,
                rawDate: null
            ...
            // Merge and Sort
            const fullHistory = [...linkedBitacora, ...linkedOTs, ...existingHistorial].sort((a, b) => {
            ...
            if (fullHistory.length > 0) {
                combinedHtml = fullHistory.map(h => {
                    if (h.isBitacora) {
                        return `
                            <div style="background: rgba(59, 130, 246, 0.08); border-left: 3px solid var(--color-accent); padding: 10px; margin-bottom: 8px; border-radius: 4px;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                    <span style="font-weight: 800; font-size: 0.75rem; color: var(--color-accent);">📝 ${h.tarea}</span>
                                    <span style="font-size: 0.65rem; color: var(--color-text-muted);">${h.fecha}</span>
                                </div>
                                <div style="font-size: 0.85rem; color: #e2e8f0; line-height: 1.4;">${h.desc}</div>
                                <div style="font-size: 0.65rem; color: var(--color-text-muted); margin-top: 5px; font-style: italic;">Por: ${h.tecnico}</div>
                            </div>
                        `;
                    } else if (h.isOT) {
                        const statusColor = h.estado === 'completada' ? 'var(--color-success)' : (h.estado === 'pendiente' ? 'var(--color-warning)' : 'var(--color-primary)');
                        return `
                            <div style="background: rgba(255,255,255,0.02); border-left: 3px solid ${statusColor}; padding: 10px; margin-bottom: 8px; border-radius: 4px;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                    <span style="font-weight: 800; font-size: 0.75rem; color: ${statusColor};">${h.tarea}</span>
                                    <span style="font-size: 0.65rem; color: var(--color-text-muted);">${h.fecha}</span>
                                </div>
                                <div style="font-size: 0.85rem; color: #e2e8f0; line-height: 1.4;">${h.desc}</div>
                                <div style="font-size: 0.65rem; color: var(--color-text-muted); margin-top: 5px; display:flex; justify-content:space-between;">
                                    <span>Técnico: ${h.tecnico}</span>
                                    <span style="font-weight:bold; opacity:0.8; font-size: 0.6rem; border: 1px solid ${statusColor}; padding: 1px 4px; border-radius: 3px; color: ${statusColor};">${h.estado.toUpperCase()}</span>
                                </div>
                            </div>
                         `;
                    } else {
                ...
                combinedHtml = '<div style="padding: 2rem; text-align: center; color: var(--color-text-muted);">No hay intervenciones registradas.</div>';
            }

            combinedHtml += `
                <div style="font-size: 0.7rem; color: var(--color-text-muted); font-weight: 800; margin-bottom: 10px; text-transform: uppercase; border-bottom: 1px dashed rgba(255,255,255,0.1); padding-bottom: 5px;">
                    🛠️ Historial de Intervenciones (OTs)
                </div>
                ${historialHtml}
            `;

            // CRITICAL FIX: Assign the generated HTML to the container
            histContainer.innerHTML = financialHtml + combinedHtml;
        ...
        // --- WIDGETS DE BITÁCORA PARA EL DASHBOARD ---
        function renderBitacoraWidgets() {
            if (!bitacoraDatos || bitacoraDatos.length === 0) return '';

            const hoy = new Date().toISOString().split('T')[0];
            // Filtrar recordatorios pendientes (esRecordatorio=true, !completado, fecha <= hoy)
            const pendientes = bitacoraDatos.filter(e =>
                e.esRecordatorio &&
                !e.completado &&
                (e.fechaRecordatorio <= hoy || e.fechaRecordatorio === e.fecha) // Mostrar si es hoy o pasado
            );

            if (pendientes.length === 0) return '';

            const itemsHtml = pendientes.map(p => `
                <div style="background: rgba(255,255,255,0.05); padding: 10px; border-radius: 6px; border-left: 3px solid #f59e0b; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <div style="font-size: 0.8rem; font-weight: bold; color: #f59e0b;">📅 Recordatorio ${p.fechaRecordatorio}</div>
                        <div style="font-size: 0.9rem;">${p.contenido}</div>
                    </div>
                    <button onclick="marcarBitacoraOK(${p.id})" class="btn" style="padding: 4px 10px; font-size: 0.8rem; background: rgba(16, 185, 129, 0.2); color: #10b981; border: 1px solid #10b981;">
                        ✅ OK
                    </button>
                </div>
            `).join('');
            ...
            return `
                <div class="card" style="margin-bottom: 20px; border: 1px solid #f59e0b; background: rgba(245, 158, 11, 0.05);">
                    <h3 style="color: #f59e0b; margin-top: 0; display: flex; align-items: center; gap: 8px;">
                        <span class="material-symbols-rounded">notifications_active</span> 
                        Recordatorios de Bitácora
                    </h3>
        ...
        function marcarBitacoraOK(id) {
            const entry = bitacoraDatos.find(e => e.id === id);
            if (entry) {
                entry.completado = true;
                saveBitacora();
                renderCurrentView(); // Refrescar dashboard
        ...
        function simularIncidenteMayor() {
            ...
            if (equipos.length < 10) {
                ...
                localStorage.setItem('cmms_equipos', JSON.stringify(equipos)); // Persist the new equipment
            }
        ...
        function saveEquipo() {
            ...
            const tipo = document.getElementById('eq-tipo') ? document.getElementById('eq-tipo').value : "equipo";
            ...
            if (id) {
                ...
                if (idx !== -1) {
                    equipos[idx] = {
                        ...
                        especialidad, responsableId, tipo,
            ...
            closeModal();
            renderCurrentView();
            // Force refresh of assets view if we are there
            if (currentView === 'activos') navigate('activos');
        }
        ...
        function openModalTecnico(tecnico = null) {
            ...
            const deleteBtn = document.getElementById('btn-delete-tecnico');

            if (tecnico) {
                // Edit mode
                title.innerText = 'Editar Técnico';
                if (deleteBtn) deleteBtn.style.display = 'block'; // Show delete button
        ...
        function deleteTecnico() {
            ...
            if (confirm("⚠️ ¿Estás seguro de eliminar este técnico permanentemente?\n\nEsta acción no se puede deshacer.")) {
                // Remove from array by filtering
                ...
                closeModalTecnico();
                renderCurrentView(); // Re-render the list to show removal
        ...
        // --- INITIALIZATION ENGINE v3.5.2 (Cleaned up) ---
        // Removed legacy load listener that conflicted with main init logic.
        ...
        function renderBodega() {
            // Separe Items
            const tools = repuestos.filter(r => r.tipo === 'herramienta');
            const spares = repuestos.filter(r => r.tipo !== 'herramienta');
            const valorTotal = spares.reduce((acc, r) => acc + (r.stock * (r.precio || 0)), 0);
            ...
            let html = `
                <div class="view-content">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                         <h3>📦 Control de Bodega & Pañol</h3>
                        <div style="display: flex; gap: 10px;">
                            <button onclick="openModalCompras()" class="btn btn-primary" style="background: var(--color-success);">
                                <span class="material-symbols-rounded">shopping_cart</span> Ingresar Compra
                            </button>
                        </div>
                    </div>

                    <!-- TABS -->
                    <div style="display: flex; gap: 10px; margin-bottom: 20px; background: rgba(0,0,0,0.2); padding: 5px; border-radius: 8px;">
                        <button class="btn" id="tab-spares" onclick="switchBodegaTab('spares')" 
                            style="background: var(--color-primary); flex: 1; font-weight: 800; border: 1px solid var(--color-primary);">
                            📦 REPUESTOS (${spares.length})
                        </button>
                        <button class="btn" id="tab-tools" onclick="switchBodegaTab('tools')" 
                            style="background: transparent; flex: 1; font-weight: 800; border: 1px solid transparent; color: var(--color-text-muted);">
                    ...
                    <div id="view-spares">
                        <!-- KPIs -->
                        <div class="dashboard-grid" style="grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); margin-bottom: 20px;">
                            ...
                            <div class="card" style="background: rgba(255, 255, 255, 0.03);">
                                <div style="font-size: 0.65rem; color: var(--color-text-muted); font-weight: 800; text-transform: uppercase;">Items Totales</div>
                                <div style="font-size: 1.6rem; font-weight: 900; margin-top: 8px;">${spares.length}</div>
                            </div>
                        </div>
            ...
            if (spares.length === 0) {
                html += `<tr><td colspan="5" style="text-align:center; padding: 20px;">No hay repuestos registrados</td></tr>`;
            } else {
                spares.forEach(r => {
                    const statusColor = r.stock <= (r.stockMinimo || 1) ? 'var(--color-danger)' : 'var(--color-success)';
                    html += `
                    <tr>
                        <td>
                            <div style="font-weight:bold;">${r.nombre}</div>
                            <div style="font-size:0.75rem; color:var(--color-text-muted);">ID: ${r.id}</div>
                        </td>
                        <td>${r.zona || 'N/A'}</td>
                        <td>
                        ...
                        <td>${fmt.format(r.precio || 0)}</td>
                        <td style="display: flex; gap: 5px;">
                            <button class="btn btn-sm" onclick="openEditItemModal(${r.id})" title="Editar Item">
                                <span class="material-symbols-rounded" style="font-size: 1.1rem;">edit</span>
                            </button>
                            <button class="btn btn-sm" onclick="confirmDeleteRepuesto(${r.id})" style="color: var(--color-danger); background: rgba(239, 68, 68, 0.1); border-color: rgba(239, 68, 68, 0.2);" title="Eliminar Item">
                                <span class="material-symbols-rounded" style="font-size: 1.1rem;">delete</span>
                            </button>
                            <button class="btn btn-sm" onclick="alert('Historial en desarrollo')" title="Ver Historial">
            ...
            if (tools.length === 0) {
                html += `<tr><td colspan="4" style="text-align:center; padding: 20px;">No hay herramientas registradas</td></tr>`;
            } else {
                tools.forEach(t => {
                    // Estado Logic (Default 'bueno' if undefined)
                    const estado = t.estado || 'bueno';
                    ...
                    if (t.responsable) {
                        // Ensure responsible is treated as string/number correctly
                        const tec = tecnicos.find(x => x.id == t.responsable);
                        if (tec) encargadoNombre = tec.nombre;
                    }
                        ...
                        <td>
                            <div style="display:flex; align-items:center; gap:10px;">
                                <div style="background:rgba(255,255,255,0.1); padding:8px; border-radius:8px;">
                                    <span class="material-symbols-rounded" style="color:var(--color-accent);">home_repair_service</span>
                                </div>
                                <div>
                                    <div style="font-weight:bold;">${t.nombre}</div>
                                    <div style="font-size:0.75rem; color:var(--color-text-muted);">Stock: ${t.stock}</div>
                                </div>
                            </div>
                        </td>
                        <td>
                             <span class="status-badge" style="background: ${estadoColor}20; color: ${estadoColor}; border: 1px solid ${estadoColor}; display: inline-flex; align-items: center; gap: 5px;">
                                <span class="material-symbols-rounded" style="font-size:14px;">${estadoIcon}</span>
                                ${estadoText}
                            </span>
                        </td>
                        <td>
                            <div style="display: flex; align-items: center; justify-content: space-between; background: rgba(0,0,0,0.2); padding: 5px 10px; border-radius: 6px;">
                                <span style="font-weight: bold; font-size: 0.85rem;">${encargadoNombre}</span>
                                <button class="btn btn-sm" onclick="asignarHerramientaModal(${t.id})" style="background: rgba(59, 130, 246, 0.1); color: var(--color-primary); border:none;">
                                    <span class="material-symbols-rounded">person_add</span>
                                </button>
                            </div>
                        </td>
                        <td style="display: flex; gap: 5px;">
                            <button class="btn btn-sm" onclick="openEditItemModal(${t.id})" title="Editar Herramienta">
                                <span class="material-symbols-rounded" style="font-size: 1.1rem;">edit</span>
                            </button>
                            <button class="btn btn-sm" onclick="confirmDeleteRepuesto(${t.id})" style="color: var(--color-danger); background: rgba(239, 68, 68, 0.1); border-color: rgba(239, 68, 68, 0.2);" title="Eliminar Herramienta">
                                <span class="material-symbols-rounded" style="font-size: 1.1rem;">delete</span>
                            </button>
                            <button class="btn btn-sm" onclick="cambiarEstadoHerramienta(${t.id})" title="Cambiar Estado">
        ...
        function switchBodegaTab(tab) {
            const viewSpares = document.getElementById('view-spares');
            const viewTools = document.getElementById('view-tools');
            const tabSpares = document.getElementById('tab-spares');
            const tabTools = document.getElementById('tab-tools');

            if (tab === 'spares') {
                viewSpares.style.display = 'block';
                viewTools.style.display = 'none';

                tabSpares.style.background = 'var(--color-primary)';
                tabSpares.style.borderColor = 'var(--color-primary)';
                tabSpares.style.color = 'white';

                tabTools.style.background = 'transparent';
                tabTools.style.borderColor = 'transparent';
                tabTools.style.color = 'var(--color-text-muted)';
            } else {
                viewSpares.style.display = 'none';
                viewTools.style.display = 'block';

                tabTools.style.background = 'var(--color-primary)';
                tabTools.style.borderColor = 'var(--color-primary)';
                tabTools.style.color = 'white';

                tabSpares.style.background = 'transparent';
                tabSpares.style.borderColor = 'transparent';
                tabSpares.style.color = 'var(--color-text-muted)';
            }
        }
...
${ultimaIntervencion.especialidad ? `Especialidad requerida: ${ultimaIntervencion.especialidad}` : ''}
        ...
        // Bitácora Exposures
        window.openEditBitacora = openEditBitacora;
        window.saveBitacoraEntry = saveBitacoraEntry;
        window.deleteBitacoraEntry = deleteBitacoraEntry;
        window.closeBitacoraModal = closeBitacoraModal;
        window.toggleBitacoraReminder = toggleBitacoraReminder;
        window.toggleBitacoraLink = toggleBitacoraLink;
        window.updateBitacoraRooms = updateBitacoraRooms;
    ...
    <div class="mobile-nav"
        ...
        <div
            style="display: flex; justify-content: space-around; align-items: center; max-width: 600px; margin: 0 auto;">
    ...
    <!-- MODAL COMPRAS (INGRESO DE STOCK) -->
    <div id="modal-compras" class="modal-overlay">
        <div class="modal" style="max-width: 500px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                <h3 style="margin:0;"><span class="material-symbols-rounded">shopping_cart</span> Ingreso de Compras &
                    Activos</h3>
                <span onclick="closeModalCompras()" class="material-symbols-rounded"
                    style="cursor:pointer; color: var(--color-text-muted);">close</span>
            </div>

            <p style="margin-bottom: 20px; color: var(--color-text-muted);">Registre nuevas adquisiciones
                clasificándolas correctamente.</p>

            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: bold;">Tipo de Adquisición</label>
                <div style="display: flex; gap: 10px;">
                    <button type="button" class="btn btn-type-select active"
                        onclick="selectPurchaseType('insumo', this)"
                        style="flex: 1; border: 1px solid var(--color-primary); background: var(--color-primary);">Insumo
                        / Repuesto</button>
                    <button type="button" class="btn btn-type-select" onclick="selectPurchaseType('herramienta', this)"
                        style="flex: 1; border: 1px solid var(--color-text-muted); background: transparent; color: var(--color-text-muted);">Herramienta</button>
                    <button type="button" class="btn btn-type-select" onclick="selectPurchaseType('equipo', this)"
                        style="flex: 1; border: 1px solid var(--color-text-muted); background: transparent; color: var(--color-text-muted);">Maquinaria
                        / Equipo</button>
                </div>
                <input type="hidden" id="compra-tipo" value="insumo">
            </div>

            <!-- Selector de Item Existente (Solo para Insumos/Herramientas ya creadas) -->
            <div id="group-existing-item" class="form-group">
                <label>Seleccionar Item Existente (Opcional)</label>
                <select id="compra-item-existente" class="form-control" onchange="loadItemDetails(this.value)">
            ...
            <div class="form-group">
                <label>Nombre del Item / Equipo</label>
                <input type="text" id="compra-nombre" class="form-control"
                    placeholder="Ej: Rodamiento SKF, Taladro Bosch, Grúa Horquilla...">
            </div>

            <div class="grid-2">
                <div class="form-group">
                    <label>Cantidad</label>
                    <input type="number" id="compra-cantidad" class="form-control" value="1" min="1">
                </div>
                <div class="form-group">
                    <label>Costo Unitario (Neto)</label>
                    <input type="number" id="compra-costo" class="form-control" placeholder="0">
                </div>
            </div>

            <!-- Campos Específicos -->
            <div id="extra-fields"
                style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 8px; margin-bottom: 15px; display: none;">
                <div class="grid-2">
                    <div class="form-group">
                        <label>Marca / Modelo</label>
                        <input type="text" id="compra-marca" class="form-control" placeholder="Ej: Bosch GSB 18V">
                    </div>
                    <div class="form-group">
                        <label>N° Serie / Activo</label>
                        <input type="text" id="compra-serie" class="form-control" placeholder="Opcional">
                    </div>
                </div>
            </div>
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <input type="text" id="compra-proveedor" class="form-control" placeholder="Nombre Proveedor">
                </div>
                <div class="form-group">
                    <label>N° Factura / Boleta</label>
                    <input type="text" id="compra-doc" class="form-control" placeholder="Opcional">
                </div>
            </div>

            <div style="display: flex; gap: 10px; margin-top: 20px;">
                <button onclick="procesarCompraAvanzada()" class="btn btn-primary"
                    style="flex: 1; font-weight: 800; background: var(--color-success);">
                    <span class="material-symbols-rounded">check_circle</span> INGRESAR COMPRA
                </button>
                <button onclick="closeModalCompras()" class="btn"
                    style="flex: 0.5; background: var(--color-surface-hover);">CANCELAR</button>
            </div>
        </div>
    </div>

    <!-- MODAL ASIGNACION HERRAMIENTA -->
    <div id="modal-asignacion" class="modal-overlay">
        <div class="modal" style="max-width: 400px;">
            <h3>🤖 Asignar Responsable</h3>
            <p>Seleccione el técnico que quedará a cargo de esta herramienta.</p>

            <input type="hidden" id="asignacion-tool-id">

            <div class="form-group">
                <label>Técnico Responsable</label>
                <select id="asignacion-tecnico-id" class="form-control">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;">
                <button onclick="saveAsignacionHerramienta()" class="btn btn-primary" style="flex: 1;">GUARDAR</button>
                <button onclick="document.getElementById('modal-asignacion').style.display='none'" class="btn"
                    style="flex: 1; background: var(--color-surface-hover);">CANCELAR</button>
            </div>
        </div>
    </div>

    <!-- MODAL EDICIÓN DE ITEM (REPUESTO/HERRAMIENTA) -->
    <div id="modal-edit-item" class="modal-overlay">
        <div class="modal" style="max-width: 450px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                <h3 id="edit-item-title">Editar Item de Inventario</h3>
                <span onclick="document.getElementById('modal-edit-item').style.display='none'"
                    class="material-symbols-rounded"
                    style="cursor:pointer; color: var(--color-text-muted);">close</span>
            </div>

            <form id="form-edit-item" onsubmit="event.preventDefault(); saveEditItem();">
                <input type="hidden" id="edit-item-id">

                <div class="form-group">
                    <label>Nombre del Item</label>
                    <input type="text" id="edit-item-nombre" class="form-control" required>
                </div>

                <div class="grid-2">
                    <div class="form-group">
                        <label>Stock Actual</label>
                        <input type="number" id="edit-item-stock" class="form-control" required min="0">
                    </div>
                    <div class="form-group">
                        <label>Stock Mínimo</label>
                        <input type="number" id="edit-item-min" class="form-control" required min="0">
                    </div>
                </div>
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="number" id="edit-item-precio" class="form-control" required min="0">
                    </div>
                    <div class="form-group">
                        <label>Unidad</label>
                        <select id="edit-item-unidad" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="edit-item-zona" class="form-control"
                        placeholder="Ej: Pasillo A, Estante 01...">
                </div>

                <div style="display: flex; gap: 10px; margin-top: 2rem;">
                    <button type="submit" class="btn btn-primary" style="flex: 1.5; font-weight: 800;">GUARDAR
                        CAMBIOS</button>
                    <button type="button" onclick="document.getElementById('modal-edit-item').style.display='none'"
                        class="btn" style="flex: 1;">CANCELAR</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function openModalCompras() {
            ...
            const select = document.getElementById('compra-item-id');
            const cantidadInput = document.getElementById('compra-cantidad');
            const costoInput = document.getElementById('compra-costo');
            const proveedorInput = document.getElementById('compra-proveedor');
            ...
            // Group by Type
            const repuestosGroup = document.createElement('optgroup');
            repuestosGroup.label = "Repuestos";

            const herramientasGroup = document.createElement('optgroup');
            herramientasGroup.label = "Herramientas";

            // Populate options from 'repuestos' array (where type can be 'repuesto' or 'herramienta')
            // Note: If we had a separate 'herramientas' array we would iterate that too.
            // Currently data structure uses 'repuestos' for both, distinguished by 'tipo'.

            repuestos.forEach(r => {
                const opt = document.createElement('option');
                opt.value = r.id;
                opt.innerText = r.nombre + ' (Stock: ' + r.stock + ')';
                opt.dataset.cost = r.precio || 0;

                if (r.tipo === 'herramienta') {
                    herramientasGroup.appendChild(opt);
                } else {
                    repuestosGroup.appendChild(opt);
                }
            });

            select.appendChild(repuestosGroup);
            select.appendChild(herramientasGroup);
        ...
        function updateCompraUnit(select) {
            const opt = select.selectedOptions[0];
            const costoInput = document.getElementById('compra-costo');
            if (opt && opt.dataset.cost) {
                costoInput.value = opt.dataset.cost;
            } else {
                costoInput.value = '';
            }
        }
        ...
        function procesarCompra() {
            const itemId = parseInt(document.getElementById('compra-item-id').value);
            const cantidad = parseInt(document.getElementById('compra-cantidad').value);
            const costo = parseInt(document.getElementById('compra-costo').value);
            const proveedor = document.getElementById('compra-proveedor').value;
            const doc = document.getElementById('compra-doc').value;

            if (!itemId || !cantidad || !costo || !proveedor) {
                alert("Por favor complete todos los campos obligatorios.");
                return;
            }

            // Find item
            const item = repuestos.find(r => r.id === itemId);
            ...
            if (item) {
                ...
                // Update Price (Simple Update)
                item.precio = costo;

                // Log Movement (In 'ordenesCompra' or separate 'movimientos'? Using 'ordenesCompra' as history for now)
                // We should ensure 'ordenesCompra' is defined globally
                if (typeof ordenesCompra === 'undefined') window.ordenesCompra = [];
                ...
                ordenesCompra.push({
                    ...
                    documento: doc || 'S/N',
                    fecha: new Date().toISOString(),
                    usuario: currentUser ? currentUser.nombre : 'Admin',
                    tipo: 'ingreso'
                });

                persist();
                alert(`✅ INGRESO EXITOSO\n\nItem: ${item.nombre}\nStock: ${stockAnterior} ➡️ ${item.stock}\nCosto: $${costo}`);
                closeModalCompras();
                renderBodega(); // Refresh view
            } else {
                alert("Error: Item no encontrado.");
            }
        }

        function asignarHerramientaModal(id) {
            const modal = document.getElementById('modal-asignacion');
            const toolIdInput = document.getElementById('asignacion-tool-id');
            const tecnicoSelect = document.getElementById('asignacion-tecnico-id');

            toolIdInput.value = id;
            tecnicoSelect.innerHTML = '<option value="">-- Sin Asignar (Bodega) --</option>';
            ...
            // Set current value
            const tool = repuestos.find(r => r.id === id);
            if (tool && tool.responsable) {
                tecnicoSelect.value = tool.responsable;
            }

            modal.style.display = 'flex';
        }

        function saveAsignacionHerramienta() {
            const toolId = parseInt(document.getElementById('asignacion-tool-id').value);
            const tecnicoId = document.getElementById('asignacion-tecnico-id').value;

            const tool = repuestos.find(r => r.id === toolId);
            if (tool) {
                const oldResp = tool.responsable;
                tool.responsable = tecnicoId ? parseInt(tecnicoId) : null;

                persist();
                alert(`✅ ASIGNACIÓN ACTUALIZADA\n\nHerramienta: ${tool.nombre}\nResponsable: ${tecnicoId ? 'Técnico ID ' + tecnicoId : 'Bodega (Nadie)'}`);
        ...
        // --- GESTIÓN DE BODEGA: EDITAR Y BORRAR ---
        function confirmDeleteRepuesto(id) {
            const item = repuestos.find(r => r.id === id);
            if (!item) return;

            if (confirm(`¿Estás seguro de eliminar permanentemente "${item.nombre}" del inventario?\n\nEsta acción no se puede deshacer.`)) {
                repuestos = repuestos.filter(r => r.id !== id);
                persist();
                renderCurrentView();
                alert("🗑️ Item eliminado con éxito.");
            }
        }
        ...
        function openEditItemModal(id) {
            ...
            document.getElementById('edit-item-min').value = item.stockMinimo || item.critico || 0;
            document.getElementById('edit-item-precio').value = item.precio || 0;
            document.getElementById('edit-item-unidad').value = item.unidad || 'UN';
            document.getElementById('edit-item-zona').value = item.zona || '';

            document.getElementById('edit-item-title').innerText = item.tipo === 'herramienta' ? 'Editar Herramienta' : 'Editar Repuesto / Insumo';
        ...
        function saveEditItem() {
            ...
            item.stock = parseInt(document.getElementById('edit-item-stock').value);
            item.stockMinimo = parseInt(document.getElementById('edit-item-min').value);
            item.critico = item.stockMinimo; // Sync both fields used in code
            item.precio = parseInt(document.getElementById('edit-item-precio').value);
            item.unidad = document.getElementById('edit-item-unidad').value;
            item.zona = document.getElementById('edit-item-zona').value;
        ...
        // ========== LOGICA DE COMPRAS AVANZADA ==========

        function openModalCompras() {
            document.getElementById('modal-compras').style.display = 'flex';
            // Reset to Insumo by default
            const defaultBtn = document.querySelector('.btn-type-select');
            if (defaultBtn) selectPurchaseType('insumo', defaultBtn);
        }
        ...
        function selectPurchaseType(type, btn) {
            ...
            // Set Type
            document.getElementById('compra-tipo').value = type;

            // Show/Hide Extra Fields
            const extraFields = document.getElementById('extra-fields');
            const groupExisting = document.getElementById('group-existing-item');

            if (type === 'insumo') {
                extraFields.style.display = 'none';
                groupExisting.style.display = 'block';
                updateExistingItemSelect('insumo');
            } else if (type === 'herramienta') {
                extraFields.style.display = 'block';
                groupExisting.style.display = 'block';
                updateExistingItemSelect('herramienta');
            } else { // equipo
                extraFields.style.display = 'block';
                groupExisting.style.display = 'none'; // Equipos always new ideally
            }
        }

        function updateExistingItemSelect(filterType) {
            const select = document.getElementById('compra-item-existente');
            select.innerHTML = '<option value="">-- Nuevo Item --</option>';

            // Filter repuestos based on type
            const filtered = repuestos.filter(r => {
                if (filterType === 'herramienta') return r.tipo === 'herramienta';
                return r.tipo !== 'herramienta';
            });
        ...
        function loadItemDetails(id) {
            ...
            if (item) {
                ...
                nombreInput.disabled = true; // Lock name for existing items
                if (item.precio) costoInput.value = item.precio;
            }
        }

        function procesarCompraAvanzada() {
            const tipo = document.getElementById('compra-tipo').value;
            const existingId = document.getElementById('compra-item-existente').value;
            ...
            const costo = parseInt(document.getElementById('compra-costo').value) || 0;

            // Extra fields
            const marca = document.getElementById('compra-marca').value;
            const serie = document.getElementById('compra-serie').value;
            const proveedor = document.getElementById('compra-proveedor').value;
            const doc = document.getElementById('compra-doc').value;

            if (!nombre || cantidad <= 0) {
                alert("⚠️ Por favor ingrese al menos un Nombre y una Cantidad válida.");
                return;
            }

            const confirmMsg = `🛒 CONFIRMAR INGRESO\n\nTipo: ${tipo.toUpperCase()}\nItem: ${nombre}\nCant: ${cantidad}\nCosto Unit: $${costo}\nTotal: $${cantidad * costo}\n\n¿Proceder?`;

            if (!confirm(confirmMsg)) return;

            let finalId = existingId ? parseInt(existingId) : Date.now();
            let isNew = !existingId;

            // LOGICA SEGUN TIPO
            if (tipo === 'equipo') {
                // Crear Activo / Equipo (No va a Repuestos, va a Equipos)
                // Assuming 'equipos' array exists. If not, we might need a separate logic or simple alert constraint.
                // For now, let's treat it as a special repuesto or check if equipos exists.
                if (typeof equipos !== 'undefined') {
                    ...
                    alert(`✅ EQUIPO REGISTRADO: ${nombre}`);
                } else {
                    alert("⚠️ Módulo de Equipos no detectado. Se guardará como Herramienta.");
                    // Fallback to Herramienta logic
                }
            }
            else {
                // REPUESTOS O HERRAMIENTAS
                let item = repuestos.find(r => r.id == finalId);

                if (item) {
                    // Update Stock
                    item.stock += cantidad;
                    item.precio = costo > 0 ? costo : item.precio; // Update Last Price
                } else {
                    // Create New
                    item = {
                        id: finalId,
                        ...
                        stockMinimo: 5,
                        zona: 'Recepción',
                        tipo: tipo === 'herramienta' ? 'herramienta' : 'repuesto'
                    };
            ...
            // Log Transaction (Orden de Compra simulada)
            const nuevaOrden = {
                id: Date.now(),
                fecha: new Date().toISOString(),
                tipo: 'compra',
                ...
                proveedor: proveedor,
                documento: doc,
                usuario_id: currentUser ? currentUser.id : 0
            };

            // Initialize ordenesCompra if not exists
            if (typeof ordenesCompra === 'undefined') window.ordenesCompra = [];
...
`;
    ...
    <!-- MODAL GESTIÓN GANTT -->
    <div id="modal-gantt-task" class="modal-overlay"
        style="display: none; align-items: center; justify-content: center;">
        <div class="modal" style="max-width: 600px; max-height: 90vh; overflow-y: auto;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                <h3 id="gantt-modal-title">Programar Tarea Gantt</h3>
                <button class="btn" onclick="closeGanttModal()" style="background: transparent; padding: 5px;">
                    <span class="material-symbols-rounded">close</span>
                </button>
            </div>
            <form id="gantt-task-form" onsubmit="event.preventDefault(); saveGanttTask();">
                <input type="hidden" id="gantt-task-id">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group" style="grid-column: span 2;">
                        <label>Título de la Tarea</label>
                        <input type="text" id="gantt-task-title" class="form-control" required>
                    </div>
                    <div class="form-group" style="grid-column: span 2;">
                        <label>Referencia</label>
                        <div style="display: flex; gap: 15px;">
                            <label style="cursor: pointer; display: flex; align-items: center; gap: 5px;">
                                <input type="radio" name="gantt-asset-type" value="equipment" checked
                                    onchange="toggleGanttAssetType('equipment')"> Equipo / Activo
                            </label>
                            <label style="cursor: pointer; display: flex; align-items: center; gap: 5px;">
                                <input type="radio" name="gantt-asset-type" value="room"
                                    onchange="toggleGanttAssetType('room')"> Habitación
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div style="display: flex; align-items: center; justify-content: space-between;">
                            <label id="lbl-gantt-target">Equipo / Activo</label>
                            <button type="button" id="btn-add-area-gantt" class="btn btn-sm" onclick="addCustomArea()"
                                style="display: none; font-size: 0.7rem; padding: 2px 8px; border: 1px dashed var(--color-primary); color: var(--color-primary);">
                                + Crear Área
                            </button>
                        </div>
                        <select id="gantt-task-equipo" class="form-control" required></select>
                    </div>
                    <div class="form-group">
                        <label>Responsable</label>
                        <select id="gantt-task-tec" class="form-control" required></select>
                    </div>
                    <div class="form-group">
                        <label>Fecha Inicio</label>
                        <input type="date" id="gantt-task-start" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Fecha Fin (Si es multi-día)</label>
                        <input type="date" id="gantt-task-end" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Prioridad</label>
                        <select id="gantt-task-priority" class="form-control">
                            <option value="BAJA">Baja (Verde)</option>
                            <option value="MEDIA" selected>Media (Azul)</option>
                    ...
                    <div class="form-group">
                        <label>Estado</label>
                        <select id="gantt-task-status" class="form-control">
                    ...
                    <div class="form-group">
                        <label>Avance: <span id="gantt-progress-val">0</span>%</label>
                        <input type="range" id="gantt-task-progress" class="form-control" min="0" max="100" step="5"
                            value="0" oninput="document.getElementById('gantt-progress-val').innerText = this.value">
                    </div>
                    <div class="form-group" style="grid-column: span 2;">
                        <label>Notas / Instrucciones</label>
                        <textarea id="gantt-task-notes" class="form-control" rows="2"></textarea>
                    </div>

                    <div class="form-group"
                        style="grid-column: span 2; background: rgba(255,255,255,0.05); padding: 15px; border-radius: 8px; border: 1px solid var(--color-border);">
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            <label style="margin: 0; font-weight: bold; color: var(--color-primary);">Etapas del
                                Avance</label>
                            <button type="button" class="btn btn-primary" onclick="addEtapa()"
                                style="padding: 4px 10px; font-size: 0.7rem;">+ Añadir Etapa</button>
                        </div>
                        <div id="gantt-etapas-container" style="display: flex; flex-direction: column; gap: 5px;">
                            <!-- Etapas se cargarán aquí -->
                        </div>
                        <div style="font-size: 0.65rem; color: var(--color-text-muted); margin-top: 8px;">
                            * El progreso se calculará automáticamente según las etapas completadas.
                        </div>
                    </div>
                    <div class="form-group" style="grid-column: span 2;">
                        <label>Evidencia / Referencia Visual</label>
                        <input type="file" id="gantt-task-photo" class="form-control" accept="image/*"
                            onchange="previewGanttPhoto(event)">
                        <div id="gantt-photo-preview" style="margin-top: 10px; display: none;">
                            <img id="gantt-preview-img" src=""
                ...
                <div style="display: flex; gap: 10px; margin-top: 2rem;">
                    <div style="flex: 2; display: flex; gap: 5px;">
                        ...
                        <button type="button" id="btn-finish-gantt" class="btn" onclick="finishGanttTask()"
                            style="flex: 1; background: var(--color-success); border: 1px solid var(--color-success); display: none;">
                            ✓ FINALIZAR
                        </button>
                    </div>
                    <button type="button" id="btn-delete-gantt" class="btn"
                        style="flex: 1; background: rgba(239, 68, 68, 0.1); color: var(--color-danger); border: 1px solid var(--color-danger); display: none;"
                        onclick="confirmDeleteGanttTask()">ELIMINAR</button>
                    <button type="button" class="btn" style="flex: 1;" onclick="closeGanttModal()">CANCELAR</button>
                </div>
            </form>
        </div>
    </div>

    <!-- MODAL BITÁCORA (NUEVA / EDITAR) -->
    <div id="modal-bitacora" class="modal-overlay" style="display: none;">
        <div class="modal" style="max-width: 600px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                <h3 id="bit-modal-title">Nueva Entrada</h3>
                <button class="btn" onclick="closeBitacoraModal()" style="background: transparent; padding: 5px;">
                    <span class="material-symbols-rounded">close</span>
                </button>
            </div>
            <form id="bitacora-form" onsubmit="event.preventDefault(); saveBitacoraEntry();">
                <input type="hidden" id="bit-edit-id">

                <div class="form-group">
                    <label>Contenido</label>
                    <textarea id="bit-contenido-modal" class="form-control" rows="4"
                        placeholder="Describe la actividad, incidente o reunión..." required></textarea>
                </div>

                <div class="grid-2">
                    <div class="form-group">
                        <label>Categoría</label>
                        <select id="bit-categoria-modal" class="form-control">
                    ...
                    <div class="form-group" style="display: flex; flex-direction: column; justify-content: flex-end;">
                        <label
                            style="display: flex; align-items: center; gap: 8px; cursor: pointer; padding: 10px; background: rgba(255,255,255,0.05); border-radius: 8px;">
                            <input type="checkbox" id="bit-importante-modal">
                            <span style="color: var(--color-danger); font-weight: bold;">★ Marcar Importante</span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Recordatorio -->
                <div
                    style="background: rgba(245, 158, 11, 0.1); padding: 10px; border-radius: 8px; margin-bottom: 15px; border: 1px solid rgba(245, 158, 11, 0.2);">
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; margin-bottom: 8px;">
                        <input type="checkbox" id="bit-recordatorio-modal" onchange="toggleBitacoraReminder()">
                        <span style="font-weight: bold; color: var(--color-warning);">📅 Programar Recordatorio</span>
                    </label>
                    <div id="bit-reminder-date-group" style="display: none;">
                        <input type="date" id="bit-fecha-recordatorio-modal" class="form-control">
                    </div>
                </div>

                <!-- VINCULACIÓN (NUEVO) -->
                <div
                    style="background: rgba(59, 130, 246, 0.1); padding: 10px; border-radius: 8px; margin-bottom: 15px; border: 1px solid rgba(59, 130, 246, 0.2);">
                    <label
                        style="display: block; font-weight: bold; color: var(--color-primary); margin-bottom: 8px;">🔗
                        Vincular con Activo / Lugar</label>

                    <div style="display: flex; gap: 15px; margin-bottom: 10px;">
                        <label style="cursor: pointer; display: flex; align-items: center; gap: 5px;">
                            <input type="radio" name="bit-link-type" value="none" checked
                                onchange="toggleBitacoraLink()"> Ninguno
                        </label>
                        <label style="cursor: pointer; display: flex; align-items: center; gap: 5px;">
                            <input type="radio" name="bit-link-type" value="asset" onchange="toggleBitacoraLink()">
                            Equipo
                        </label>
                        <label style="cursor: pointer; display: flex; align-items: center; gap: 5px;">
                            <input type="radio" name="bit-link-type" value="room" onchange="toggleBitacoraLink()">
                            Habitación
                        </label>
                    </div>

                    <div id="bit-link-asset-group" style="display: none;">
                        <select id="bit-link-asset-select" class="form-control">
                            <option value="">-- Seleccionar Equipo --</option>
                            <!-- Populated by JS -->
                        </select>
                    </div>

                    <div id="bit-link-room-group" style="display: none;">
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                            <select id="bit-link-floor-select" class="form-control" onchange="updateBitacoraRooms()">
                                <option value="">Piso...</option>
                                <option value="S1">S1</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <!-- Basic floors, others manually typed if needed or simplified -->
                            </select>
                            <input type="text" id="bit-link-room-input" class="form-control"
                ...
                <div style="display: flex; gap: 10px; margin-top: 2rem;">
                    ...
                    <button type="button" id="btn-delete-bitacora" class="btn"
                        style="flex: 1; background: rgba(239, 68, 68, 0.1); color: var(--color-danger); border: 1px solid var(--color-danger); display: none;"
                        onclick="deleteBitacoraEntry()">ELIMINAR</button>
                    <button type="button" class="btn" style="flex: 1;" onclick="closeBitacoraModal()">CANCELAR</button>
                </div>
            </form>
        </div>
    </div>

    <!-- MODAL REGISTRO DE HABITACIONES -->
    <div id="modal-room-reg" class="modal-overlay" style="display: none;">
        <div class="modal" style="max-width: 500px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                <h3>Registrar Movimiento Habitación</h3>
                <button class="btn" onclick="closeHabitacionModal()" style="background: transparent; padding: 5px;">
                    <span class="material-symbols-rounded">close</span>
                </button>
            </div>
            <form id="room-form" onsubmit="event.preventDefault(); saveHabitacion();">
                <input type="hidden" id="room-edit-id">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                        <label>Piso</label>
                        <select id="room-piso" class="form-control" required>
                            <option value="">Seleccionar...</option>
                            <option value="S6">Subterráneo 6</option>
                            <option value="S5">Subterráneo 5</option>
                            <option value="S4">Subterráneo 4</option>
                            <option value="S3">Subterráneo 3</option>
                            <option value="S2">Subterráneo 2</option>
                            <option value="S1">Subterráneo 1</option>
                            ...
                            <option value="12">Piso 12</option>
                            <option value="13">Piso 13</option>
                            <option value="14">Piso 14</option>
                            <option value="15">Piso 15</option>
                            <option value="16">Piso 16</option>
                            <option value="17">Piso 17</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Habitación</label>
                        <input type="text" id="room-id" class="form-control" placeholder="Ej: 101" required>
                    </div>
                    <div class="form-group" style="grid-column: span 2;">
                        <label>Tipo de Movimiento</label>
                        <select id="room-type" class="form-control" required>
                            <option value="tomada">Habitación TOMADA</option>
                            <option value="entregada">Habitación ENTREGADA</option>
                        </select>
                    </div>
                    <div class="form-group" style="grid-column: span 2;">
                        <label>Técnico Encargado</label>
                        <select id="room-tecnico" class="form-control" required>
                    ...
                    <div class="form-group" style="grid-column: span 2;">
                        ...
                        <div
                            style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; background: rgba(0,0,0,0.2); padding: 15px; border-radius: 8px; border: 1px solid var(--color-border);">
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Pintura" class="work-item"> Pintura
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Silicona" class="work-item"> Silicona
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Sifón" class="work-item"> Sifón
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Electricidad" class="work-item"> Electricidad
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Fancoil" class="work-item"> Fancoil
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Aire Acondicionado" class="work-item"> Aire Cuartos
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Llaves de Agua" class="work-item"> Llaves de Agua
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Iluminación" class="work-item"> Iluminación
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" value="Otros" id="work-otros" class="work-item"
                                    onchange="toggleOtrosDetail()"> Otros
                            </label>
                        </div>
                    </div>
                    <div class="form-group" id="otros-detail-container" style="grid-column: span 2; display: none;">
                        <label>Describa qué sería ese "Otro"</label>
                        <textarea id="work-otros-detail" class="form-control" rows="2"
                ...
                <div style="display: flex; gap: 10px; margin-top: 2rem;">
                    ...
                    <button type="button" class="btn" style="flex: 0.5;"
                        onclick="closeHabitacionModal()">CANCELAR</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="modal-room-history" class="modal-overlay" style="display: none;">
        <div class="modal" style="max-width: 500px; max-height: 80vh; display: flex; flex-direction: column;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                <h3 id="room-history-title">Historial Habitación</h3>
                <button class="btn" onclick="closeRoomHistoryModal()" style="background: transparent; padding: 5px;">
                    <span class="material-symbols-rounded">close</span>
                </button>
            </div>
            <div id="room-history-content" style="overflow-y: auto; padding-right: 5px;">
                <!-- Content generated via JS -->
            </div>
            <div style="margin-top: 1rem; text-align: right;">
                <button class="btn" onclick="closeRoomHistoryModal()"
                    style="border: 1px solid var(--color-border);">Cerrar</button>
            </div>
        </div>
    </div>
